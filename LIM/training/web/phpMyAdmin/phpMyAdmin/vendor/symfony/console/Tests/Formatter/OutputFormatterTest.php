...
class OutputFormatterTest extends TestCase
{
    ...
    {
        return array(array('<unknown=_unknown_>'), array('<unknown=_unknown_;a=1;b>'), array('<fg=green;>', "\33[32m[test]\33[39m", '[test]'), array('<fg=green;bg=blue;>', "\33[32;44ma\33[39;49m", 'a'), array('<fg=green;options=bold>', "\33[32;1mb\33[39;22m", 'b'), array('<fg=green;options=reverse;>', "\33[32;7m<a>\33[39;27m", '<a>'), array('<fg=green;options=bold,underscore>', "\33[32;1;4mz\33[39;22;24m", 'z'), array('<fg=green;options=bold,underscore,reverse;>', "\33[32;1;4;7md\33[39;22;24;27m", 'd'));
    }
    /**
     * @group legacy
    ...
    {
        return array(array('<options=abc;>', 'abc'), array('<options=abc,def;>', 'abc'), array('<fg=green;options=xyz;>', 'xyz'), array('<fg=green;options=efg,abc>', 'efg'));
    }
