...
class ExceptionHandlerTest extends TestCase
{
    ...
    public function testStatusCode()
    {
        ...
        $expectedHeaders = array(array('HTTP/1.0 404', true, null), array('Content-Type: text/html; charset=iso8859-1', true, null));
    ...
    public function testHeaders()
    {
        ...
        $response = ob_get_clean();
        $expectedHeaders = array(array('HTTP/1.0 405', true, null), array('Allow: POST', false, null), array('Content-Type: text/html; charset=iso8859-1', true, null));
        $this->assertSame($expectedHeaders, testHeader());
    }
