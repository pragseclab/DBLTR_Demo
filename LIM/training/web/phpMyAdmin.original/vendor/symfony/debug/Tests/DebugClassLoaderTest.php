...
class DebugClassLoaderTest extends TestCase
{
    ...
    public function testDeprecatedSuper($class, $super, $type)
    {
        ...
        $xError = array('type' => E_USER_DEPRECATED, 'message' => 'The Test\\Symfony\\Component\\Debug\\Tests\\' . $class . ' class ' . $type . ' Symfony\\Component\\Debug\\Tests\\Fixtures\\' . $super . ' that is deprecated but this is a test deprecation notice.');
        $this->assertSame($xError, $lastError);
    }
    public function provideDeprecatedSuper()
    {
        return array(array('DeprecatedInterfaceClass', 'DeprecatedInterface', 'implements'), array('DeprecatedParentClass', 'DeprecatedClass', 'extends'));
    }
    public function testInterfaceExtendsDeprecatedInterface()
    {
        ...
        $lastError = error_get_last();
        unset($lastError['file'], $lastError['line']);
        $xError = array('type' => E_USER_NOTICE, 'message' => '');
        $this->assertSame($xError, $lastError);
    }
    ...
    public function testReservedForPhp7()
    {
        ...
        $lastError = error_get_last();
        unset($lastError['file'], $lastError['line']);
        $xError = array('type' => E_USER_DEPRECATED, 'message' => 'Test\\Symfony\\Component\\Debug\\Tests\\Float uses a reserved class name (Float) that will break on PHP 7 and higher');
        $this->assertSame($xError, $lastError);
    }
}
class ClassLoader
