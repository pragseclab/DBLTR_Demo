...
if (isset($_GET['action'])) {
    ...
    if ('confirm' === $_GET['action']) {
        ...
        ?>
					<p><?php 
        printf($manage_actions[$site_action], $site_address);
        ?></p>
					<?php 
    ...
    switch ($_GET['action']) {
        ...
        case 'allblogs':
            if (isset($_POST['action']) && isset($_POST['allblogs'])) {
                ...
                $location = remove_query_arg(array('_wp_http_referer', '_wpnonce'), add_query_arg($_POST, network_admin_url('sites.php')));
