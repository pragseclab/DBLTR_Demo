...
class Theme_Installer_Skin extends WP_Upgrader_Skin
{
    ...
    public function after()
    {
        ...
        if (current_user_can('edit_theme_options') && current_user_can('customize')) {
            $customize_url = add_query_arg(array('theme' => urlencode($stylesheet), 'return' => urlencode(admin_url('web' === $this->type ? 'theme-install.php' : 'themes.php'))), admin_url('customize.php'));
    ...
    private function do_overwrite()
    {
        ...
        $rows = array('Name' => __('Theme name'), 'Version' => __('Version'), 'Author' => __('Author'), 'RequiresWP' => __('Required WordPress version'), 'RequiresPHP' => __('Required PHP version'), 'Template' => __('Parent theme'));
        ...
        if ($can_update) {
            ...
            $install_actions['overwrite_theme'] = sprintf('<a class="button button-primary update-from-upload-overwrite" href="%s" target="_parent">%s</a>', wp_nonce_url(add_query_arg('overwrite', $overwrite, $this->url), 'theme-upload'), _x('Replace current with uploaded', 'theme'));
        } else {
