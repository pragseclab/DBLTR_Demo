...
class Language_Pack_Upgrader extends WP_Upgrader
{
    ...
    public function bulk_upgrade($language_updates = array(), $args = array())
    {
        ...
        foreach ($language_updates as $language_update) {
            ...
            $options = array(
                ...
                'clear_working' => true,
                'is_multi' => true,
                'hook_extra' => array('language_update_type' => $language_update->type, 'language_update' => $language_update),
            );
    ...
    public function check_package($source, $remote_source)
    {
        ...
        if (!$mo || !$po) {
            return new WP_Error('incompatible_archive_pomo', $this->strings['incompatible_archive'], sprintf(
