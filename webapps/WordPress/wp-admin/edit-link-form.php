...
<h2 class="postbox-header"><label for="link_name"><?php 
_ex('Name', 'link name');
?></label></h2>
<div class="inside">
...
<h2 class="postbox-header"><label for="link_url"><?php 
_e('Web Address');
?></label></h2>
<div class="inside">
...
?>" id="link_url" />
	<p><?php 
_e('Example: <code>https://wordpress.org/</code> &#8212; don&#8217;t forget the <code>https://</code>');
?></p>
</div>
</div>

<div id="descriptiondiv" class="postbox">
<h2 class="postbox-header"><label for="link_description"><?php 
_e('Description');
?></label></h2>
<div class="inside">
