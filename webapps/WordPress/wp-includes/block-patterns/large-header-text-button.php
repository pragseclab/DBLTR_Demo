 ...
 * @package WordPress
 */
return array('title' => _x('Large header with text and a button.', 'Block pattern title'), 'categories' => array('header'), 'content' => '<!-- wp:cover {"url":"https://s.w.org/images/core/5.8/art-01.jpg","id":null,"hasParallax":true,"dimRatio":40,"customOverlayColor":"#000000","minHeight":100,"minHeightUnit":"vh","contentPosition":"center center","align":"full"} -->
	...
	<!-- /wp:column --></div>
	<!-- /wp:columns --></div></div>
	<!-- /wp:cover -->', 'description' => _x('Large header with background image and text and button on top', 'Block pattern description'));