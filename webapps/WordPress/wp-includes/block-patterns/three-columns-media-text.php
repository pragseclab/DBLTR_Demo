 ...
 * @package WordPress
 */
return array('title' => _x('Three columns with images and text', 'Block pattern title'), 'categories' => array('columns'), 'content' => '<!-- wp:group {"align":"full","style":{"color":{"background":"#f8f4e4"}}} -->
	...
	<!-- /wp:column --></div>
	<!-- /wp:columns --></div></div>
	<!-- /wp:group -->', 'description' => _x('Three columns with images and text', 'Block pattern description'));