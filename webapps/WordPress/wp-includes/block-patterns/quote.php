 ...
 * @package WordPress
 */
return array('title' => _x('Quote', 'Block pattern title'), 'categories' => array('text'), 'blockTypes' => array('core/quote'), 'content' => '<!-- wp:group -->
	...
	<!-- /wp:group -->', 'description' => _x('Testimonial quote with portrait', 'Block pattern description'));