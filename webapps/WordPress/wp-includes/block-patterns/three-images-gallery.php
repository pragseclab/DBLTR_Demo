 ...
 * @package WordPress
 */
return array('title' => _x('Three columns with offset images', 'Block pattern title'), 'categories' => array('gallery'), 'content' => '<!-- wp:columns {"align":"wide"} -->
	...
	<!-- /wp:spacer --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->', 'description' => _x('Three columns with offset images', 'Block pattern description'));