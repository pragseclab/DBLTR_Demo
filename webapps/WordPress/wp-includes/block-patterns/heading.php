 ...
 * @package WordPress
 */
return array('title' => _x('Heading', 'Block pattern title'), 'categories' => array('text'), 'blockTypes' => array('core/heading'), 'content' => '<!-- wp:heading {"align":"wide","style":{"typography":{"fontSize":"48px","lineHeight":"1.1"}}} -->
	...
	<!-- /wp:heading -->', 'description' => _x('Heading text', 'Block pattern description'));