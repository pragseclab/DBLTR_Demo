 ...
 * @package WordPress
 */
return array('title' => _x('Three columns of text', 'Block pattern title'), 'categories' => array('columns', 'text'), 'content' => '<!-- wp:columns {"align":"full","style":{"color":{"text":"#000000","background":"#ffffff"}}} -->
	...
	<!-- /wp:paragraph --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->', 'description' => _x('Three columns of text', 'Block pattern description'));