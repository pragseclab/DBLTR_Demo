...
class getID3
{
    ...
    public function __construct()
    {
        ...
        if (($mbstring_func_overload = (int) ini_get('mbstring.func_overload')) && $mbstring_func_overload & 0x2) {
        ...
        if (empty($format_info)) {
            $format_info = array(
                ...
                */
                ...
                'dsdiff' => array('pattern' => '^FRM8', 'group' => 'audio', 'module' => 'dsdiff', 'mime_type' => 'audio/dsd'),
                ...
                'tak' => array('pattern' => '^tBaK', 'group' => 'audio', 'module' => 'tak', 'mime_type' => 'application/octet-stream'),
                ...
                // IVF - audio/video - IVF
                'ivf' => array('pattern' => '^DKIF', 'group' => 'audio-video', 'module' => 'ivf', 'mime_type' => 'video/x-ivf'),
                // MKAV - audio/video - Mastroka
                'matroska' => array('pattern' => '^\\x1A\\x45\\xDF\\xA3', 'group' => 'audio-video', 'module' => 'matroska', 'mime_type' => 'video/x-matroska'),
                ...
                'wtv' => array('pattern' => '^\\xB7\\xD8\\x00\\x20\\x37\\x49\\xDA\\x11\\xA6\\x4E\\x00\\x07\\xE9\\x5E\\xAD\\x8D', 'group' => 'audio-video', 'module' => 'wtv', 'mime_type' => 'video/x-ms-wtv'),
                // Still-Image formats
                ...
                'hpk' => array('pattern' => '^BPUL', 'group' => 'archive', 'module' => 'hpk', 'mime_type' => 'application/octet-stream', 'fail_id3' => 'ERROR', 'fail_ape' => 'ERROR'),
                // RAR  - data        - RAR compressed data
                'rar' => array('pattern' => '^Rar\\!', 'group' => 'archive', 'module' => 'rar', 'mime_type' => 'application/vnd.rar', 'fail_id3' => 'ERROR', 'fail_ape' => 'ERROR'),
    ...
    public function HandleAllTags()
    {
        ...
        foreach ($tags as $comment_name => $tagname_encoding_array) {
            ...
            if (!empty($this->info[$comment_name]['comments'])) {
                ...
                $this->CharConvert($this->info['tags'][$tag_name], $this->info[$comment_name]['encoding']);
    ...
    public static function is_writable($filename)
    {
        ...
        if (!$ret) {
            ...
            $ret = $perms & 0x80 || $perms & 0x10 || $perms & 0x2;
        }
        return $ret;
    }
}
