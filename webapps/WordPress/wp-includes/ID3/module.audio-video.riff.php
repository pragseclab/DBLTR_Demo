...
class getid3_riff extends getid3_handler
{
        ...
        switch ($RIFFsubtype) {
            ...
            case 'WEBP':
                ...
                if (!empty($thisfile_riff['WEBP']['VP8 '][0]['size'])) {
                    ...
                    if (substr($WEBP_VP8_header, 3, 3) == "\x9d\x01*") {
                        ...
                        $thisfile_riff['WEBP']['VP8 '][0]['show_frame'] = getid3_lib::LittleEndian2Int(substr($WEBP_VP8_header, 0, 3)) & 0x80000;
                        $thisfile_riff['WEBP']['VP8 '][0]['data_bytes'] = (getid3_lib::LittleEndian2Int(substr($WEBP_VP8_header, 0, 3)) & 0x7ffff) >> 0;
                ...
                if (!empty($thisfile_riff['WEBP']['VP8L'][0]['size'])) {
                    ...
                    $this->fseek($old_offset);
                    if (substr($WEBP_VP8L_header, 0, 1) == "/") {
    ...
    public function ParseRIFFAMV($startoffset, $maxoffset)
    {
        ...
        try {
            ...
            if (substr($AMVheader, 8, 4) != "8\x00\x00\x00") {
            ...
            if (substr($AMVheader, 68, 20) != 'LIST' . "\x00\x00\x00\x00" . 'strlstrh' . "8\x00\x00\x00") {
            ...
            if (substr($AMVheader, 144, 8) != 'strf' . "\$\x00\x00\x00") {
            ...
            if (substr($AMVheader, 188, 20) != 'LIST' . "\x00\x00\x00\x00" . 'strlstrh' . "0\x00\x00\x00") {
    ...
    public function parseWavPackHeader($WavPackChunkData)
    {
        ...
        if ($thisfile_wavpack['version'] >= 3) {
            ...
            $thisfile_wavpack_flags['mono'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x1);
            $thisfile_wavpack_flags['fast_mode'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x2);
            $thisfile_wavpack_flags['raw_mode'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x4);
            $thisfile_wavpack_flags['calc_noise'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x8);
            $thisfile_wavpack_flags['high_quality'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x10);
            $thisfile_wavpack_flags['3_byte_samples'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x20);
            $thisfile_wavpack_flags['over_20_bits'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x40);
            $thisfile_wavpack_flags['use_wvc'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x80);
            $thisfile_wavpack_flags['noiseshaping'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x100);
            $thisfile_wavpack_flags['very_fast_mode'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x200);
            $thisfile_wavpack_flags['new_high_quality'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x400);
            $thisfile_wavpack_flags['cancel_extreme'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x800);
            $thisfile_wavpack_flags['cross_decorrelation'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x1000);
            $thisfile_wavpack_flags['new_decorrelation'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x2000);
            $thisfile_wavpack_flags['joint_stereo'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x4000);
            $thisfile_wavpack_flags['extra_decorrelation'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x8000);
            $thisfile_wavpack_flags['override_noiseshape'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x10000);
            $thisfile_wavpack_flags['override_jointstereo'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x20000);
            $thisfile_wavpack_flags['copy_source_filetime'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x40000);
            $thisfile_wavpack_flags['create_exe'] = (bool) ($thisfile_wavpack['flags_raw'] & 0x80000);
        }
        return true;
    }
    /**
