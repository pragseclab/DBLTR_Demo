...
class getid3_ac3 extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        $thisfile_ac3_raw_bsi['bsid'] = (getid3_lib::LittleEndian2Int(substr($tempAC3header, 5, 1)) & 0xf8) >> 3;
        ...
        if ($thisfile_ac3_raw_bsi['bsid'] <= 8) {
            ...
            $thisfile_ac3_raw_bsi['flags']['langcod'] = (bool) $this->readHeaderBSI(1);
            ...
            $thisfile_ac3_raw_bsi['flags']['audprodinfo'] = (bool) $this->readHeaderBSI(1);
            ...
            $thisfile_ac3_raw_bsi['flags']['langcod2'] = (bool) $this->readHeaderBSI(1);
            ...
            $thisfile_ac3_raw_bsi['flags']['audprodinfo2'] = (bool) $this->readHeaderBSI(1);
            ...
            if ($thisfile_ac3_raw_bsi['flags']['addbsi']) {
                $thisfile_ac3_raw_bsi['addbsi_length'] = $this->readHeaderBSI(6) + 1;
            ...
            if ($thisfile_ac3_raw_bsi['flags']['mixmdat']) {
                ...
                if ($thisfile_ac3_raw_bsi['acmod'] & 0x1 && $thisfile_ac3_raw_bsi['acmod'] > 2) {
    ...
    {
        static $sampleRateCodeLookup2 = array(0 => 24000, 1 => 22050, 2 => 16000, 3 => 'reserved');
    ...
    {
        $lookup = array('ch1' => $acmod == 0, 'ch2' => $acmod == 0, 'left' => $acmod > 1, 'right' => $acmod > 1, 'center' => (bool) ($acmod & 0x1), 'surround_mono' => false, 'surround_left' => false, 'surround_right' => false, 'lfe' => $lfeon);
        switch ($acmod) {
            case 4:
            case 5:
    ...
    public static function frameSizeLookup($frmsizecod, $fscod)
    {
        ...
        if (empty($frameSizeLookup)) {
            $frameSizeLookup = array(
                ...
                9 => array(640, 696, 960),
                // 160 kbps
                10 => array(768, 834, 1152),
                // 192 kbps
                11 => array(896, 974, 1344),
                // 224 kbps
                12 => array(1024, 1114, 1536),
                // 256 kbps
                13 => array(1280, 1392, 1920),
                // 320 kbps
                14 => array(1536, 1670, 2304),
                // 384 kbps
                15 => array(1792, 1950, 2688),
                // 448 kbps
                16 => array(2048, 2228, 3072),
                // 512 kbps
                17 => array(2304, 2506, 3456),
                // 576 kbps
                18 => array(2560, 2786, 3840),
            );
        }
        $paddingBytes = 0;
        if ($fscod == 1 && $padding) {
