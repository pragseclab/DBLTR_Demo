...
class WP_REST_Terms_Controller extends WP_REST_Controller
{
    ...
    protected function prepare_links($term)
    {
        ...
        $links = array('self' => array('href' => rest_url(trailingslashit($base) . $term->term_id)), 'collection' => array('href' => rest_url($base)), 'about' => array('href' => rest_url(sprintf('wp/v2/taxonomies/%s', $this->taxonomy))));
        if ($term->parent) {
        ...
        foreach ($taxonomy_obj->object_type as $type) {
            ...
            $post_type_links[] = array('href' => add_query_arg($this->rest_base, $term->term_id, rest_url(sprintf('wp/v2/%s', $rest_base))));
        }
