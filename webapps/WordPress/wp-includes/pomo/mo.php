    ...
    class MO extends Gettext_Translations
    {
        ...
        function export_to_file_handle($fh)
        {
            ...
            foreach ($entries as $entry) {
                $originals_table .= $this->export_original($entry) . "\x00";
            ...
            $translations_table = $exported_headers . "\x00";
            foreach ($entries as $entry) {
                $translations_table .= $this->export_translations($entry) . "\x00";
        ...
        function export_original($entry)
        {
            ...
            if ($entry->is_plural) {
                $exported .= "\x00" . $entry->plural;
            }
            if ($entry->context) {
                $exported = $entry->context . "\x04" . $exported;
            }
            return $exported;
        }
        /**
        ...
        {
            // TODO: Warnings for control characters.
            return $entry->is_plural ? implode("\x00", $entry->translations) : $entry->translations[0];
        }
        /**
         * @return string
         */
