...
<?php 
	...
	<h3><?php 
            ...
            ?></h3>
	<p><?php 
            _e('To make it simpler for you to edit and save the imported content, you may want to reassign the author of the imported item to an existing user of this site, such as your primary administrator account.', 'wordpress-importer');
            ?></p>
<?php 
...
<?php 
    ...
    function author_select($n, $author)
    {
        ...
        echo '</label>';
        echo ' ' . wp_dropdown_users(array('name' => "user_map[{$n}]", 'id' => 'imported_authors_' . $n, 'multi' => true, 'show_option_all' => __('- Select -', 'wordpress-importer'), 'show' => 'display_name_with_login', 'echo' => 0));
    ...
    function process_categories()
    {
        ...
        foreach ($this->categories as $cat) {
            ...
            $data = array('category_nicename' => $cat['category_nicename'], 'category_parent' => $parent, 'cat_name' => wp_slash($cat['cat_name']), 'category_description' => wp_slash($description));
    ...
    function process_tags()
    {
        ...
        foreach ($this->tags as $tag) {
            ...
            $args = array('slug' => $tag['tag_slug'], 'description' => wp_slash($description));
    ...
    function process_terms()
    {
        ...
        foreach ($this->terms as $term) {
            ...
            $args = array('slug' => $term['slug'], 'description' => wp_slash($description), 'parent' => (int) $parent);
            ...
            if (!empty($post['comments'])) {
                ...
                foreach ($newcomments as $key => $comment) {
                    ...
                    if (!$post_exists || !comment_exists($comment['comment_author'], $comment['comment_date'])) {
                        ...
                        unset($comment_data['commentmeta']);
                        // Handled separately, wp_insert_comment() also expects `comment_meta`.
    ...
    function fetch_remote_file($url, $post)
    {
        ...
        $remote_response = wp_safe_remote_get($url, array('timeout' => 300, 'stream' => true, 'filename' => $tmp_file_name, 'headers' => array('Accept-Encoding' => 'identity')));
        ...
        $upload = array('file' => $new_file, 'url' => $uploads['url'] . "/{$file_name}", 'type' => $wp_filetype['type'], 'error' => false);
