...
function twentyfifteen_custom_header_setup()
{
    ...
    add_theme_support(
         ...
         * }
         */
        apply_filters('twentyfifteen_custom_header_args', array('default-text-color' => $default_text_color, 'width' => 954, 'height' => 1300, 'wp-head-callback' => 'twentyfifteen_header_style'))
    );
}
