...
while (have_posts()) {
    ...
    previous_image_link(false, __('Previous Image', 'twentysixteen'));
    ?></div>
						<div class="nav-next"><?php 
    next_image_link(false, __('Next Image', 'twentysixteen'));
    ?></div>
					</div><!-- .nav-links -->
    ...
    the_post_navigation(array('prev_text' => _x('<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'twentysixteen')));
    // End the loop.
}
?>
