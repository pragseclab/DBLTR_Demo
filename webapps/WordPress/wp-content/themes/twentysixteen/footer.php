...
if (has_nav_menu('primary')) {
    ?>
				<nav class="main-navigation" role="navigation" aria-label="<?php 
    esc_attr_e('Footer Primary Menu', 'twentysixteen');
    ?>">
					<?php 
...
if (has_nav_menu('social')) {
    ?>
				<nav class="social-navigation" role="navigation" aria-label="<?php 
    esc_attr_e('Footer Social Links Menu', 'twentysixteen');
    ?>">
					<?php 
...
?>
				<span class="site-title"><a href="<?php 
