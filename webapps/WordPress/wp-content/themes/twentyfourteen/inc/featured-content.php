...
class Featured_Content
{
    ...
    {
        $wp_customize->add_section('featured_content', array('title' => __('Featured Content', 'twentyfourteen'), 'description' => sprintf(
        ...
        ), 'priority' => 130, 'theme_supports' => 'featured-content'));
