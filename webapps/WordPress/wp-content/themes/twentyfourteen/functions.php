...
if (!function_exists('twentyfourteen_setup')) {
    ...
    function twentyfourteen_setup()
    {
        ...
        add_theme_support(
             ...
             * }
             */
            apply_filters('twentyfourteen_custom_background_args', array('default-color' => 'f5f5f5'))
        );
...
function twentyfourteen_font_url()
{
    ...
    if ('off' !== _x('on', 'Lato font: on or off', 'twentyfourteen')) {
        $query_args = array('family' => urlencode('Lato:300,400,700,900,300italic,400italic,700italic'), 'subset' => urlencode('latin,latin-ext'), 'display' => urlencode('fallback'));
