...
if (!function_exists('twentynineteen_entry_footer')) {
    ...
    function twentynineteen_entry_footer()
    {
        ...
        ), get_the_title()), '<span class="edit-link">' . twentynineteen_get_icon_svg('edit', 16), '</span>');
    }
}
if (!function_exists('twentynineteen_post_thumbnail')) {
    ...
    function twentynineteen_post_thumbnail()
    {
		...
		<figure class="post-thumbnail">
			<a class="post-thumbnail-inner" href="<?php 
            the_permalink();
...
if (!function_exists('twentynineteen_the_posts_navigation')) {
    ...
    {
        the_posts_pagination(array('mid_size' => 2, 'prev_text' => sprintf('%s <span class="nav-prev-text">%s</span>', twentynineteen_get_icon_svg('chevron_left', 22), __('Newer posts', 'twentynineteen')), 'next_text' => sprintf('<span class="nav-next-text">%s</span> %s', __('Older posts', 'twentynineteen'), twentynineteen_get_icon_svg('chevron_right', 22))));
    }
}
