...
function twentytwenty_get_custom_logo($html)
{
    ...
    if ($logo) {
        ...
        if (get_theme_mod('retina_logo', false)) {
            ...
            $replace = array("width=\"{$logo_width}\"", "height=\"{$logo_height}\"");
...
function twentytwenty_sidebar_registration()
{
    ...
    // Footer #1.
    register_sidebar(array_merge($shared_args, array('name' => __('Footer #1', 'twentytwenty'), 'id' => 'sidebar-1', 'description' => __('Widgets in this area will be displayed in the first column in the footer.', 'twentytwenty'))));
    // Footer #2.
    register_sidebar(array_merge($shared_args, array('name' => __('Footer #2', 'twentytwenty'), 'id' => 'sidebar-2', 'description' => __('Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty'))));
}
...
function twentytwenty_block_editor_settings()
{
    ...
    $editor_color_palette[] = array('name' => __('Background Color', 'twentytwenty'), 'slug' => 'background', 'color' => '#' . $background_color);
