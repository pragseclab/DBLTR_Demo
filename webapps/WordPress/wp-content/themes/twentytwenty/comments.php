...
if ($comments) {
    ...
    if (!have_comments()) {
        ...
        printf(
            ...
            _nx('%1$s reply on &ldquo;%2$s&rdquo;', '%1$s replies on &ldquo;%2$s&rdquo;', $comments_number, 'comments title', 'twentytwenty'),
    ...
    ?>
		...
		<div class="comments-inner section-inner thin max-percentage">
			...
			<?php 
    wp_list_comments(array('walker' => new TwentyTwenty_Walker_Comment(), 'avatar_size' => 120, 'style' => 'div'));
