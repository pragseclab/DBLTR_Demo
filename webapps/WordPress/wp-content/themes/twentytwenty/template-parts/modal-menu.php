...
if (has_nav_menu('expanded')) {
    ...
    echo esc_attr($expanded_nav_classes);
    ?>" aria-label="<?php 
    echo esc_attr_x('Expanded', 'menu', 'twentytwenty');
    ?>" role="navigation">
...
if ('expanded' !== $mobile_menu_location) {
    ...
    echo esc_attr_x('Mobile', 'menu', 'twentytwenty');
    ?>" role="navigation">
    ...
    if ($mobile_menu_location) {
        ...
        wp_list_pages(array('match_menu_classes' => true, 'show_toggles' => true, 'title_li' => false, 'walker' => new TwentyTwenty_Walker_Page()));
    }
    ?>
