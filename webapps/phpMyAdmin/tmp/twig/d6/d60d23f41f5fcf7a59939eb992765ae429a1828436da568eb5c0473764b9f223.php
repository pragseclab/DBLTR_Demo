...
class __TwigTemplate_9219340809052c11d9eb177619568a76273a78bd6e1ffbf1776db1ee846e0651 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 4
        echo "        ";
        $this->loadTemplate("console/toolbar.twig", "console/display.twig", 4)->display(twig_to_array(["parent_div_classes" => "collapsed", "content_array" => [0 => [0 => "switch_button console_switch", 1 => _gettext("Console"), "image" => $context["image"] ?? null], 1 => [0 => "button clear", 1 => _gettext("Clear")], 2 => [0 => "button history", 1 => _gettext("History")], 3 => [0 => "button options", 1 => _gettext("Options")], 4 => isset($context["cfg_bookmark"]) || array_key_exists("cfg_bookmark", $context) ? [0 => "button bookmarks", 1 => _gettext("Bookmarks")] : null, 5 => [0 => "button debug hide", 1 => _gettext("Debug SQL")]]]));
        // line 15
        echo "        ";
        // line 16
        ...
        if (!twig_test_empty($context["sql_history"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["record"]) {
                ...
                echo "\">\n                            ";
                // line 31
                $this->loadTemplate("console/query_action.twig", "console/display.twig", 31)->display(twig_to_array(["parent_div_classes" => "action_content", "content_array" => [0 => [0 => "action collapse", 1 => _gettext("Collapse")], 1 => [0 => "action expand", 1 => _gettext("Expand")], 2 => [0 => "action requery", 1 => _gettext("Requery")], 3 => [0 => "action edit", 1 => _gettext("Edit")], 4 => [0 => "action explain", 1 => _gettext("Explain")], 5 => [0 => "action profiling", 1 => _gettext("Profiling")], 6 => isset($context["cfg_bookmark"]) || array_key_exists("cfg_bookmark", $context) ? [0 => "action bookmark", 1 => _gettext("Bookmark")] : null, 7 => [0 => "text failed", 1 => _gettext("Query failed")], 8 => [0 => "text targetdb", 1 => _gettext("Database"), "extraSpan" => ($__internal_68aa442c1d43d3410ea8f958ba9090f3eaa9a76f8de8fc9be4d6c7389ba28002 = $context["record"]) && is_array($__internal_68aa442c1d43d3410ea8f958ba9090f3eaa9a76f8de8fc9be4d6c7389ba28002) || $__internal_68aa442c1d43d3410ea8f958ba9090f3eaa9a76f8de8fc9be4d6c7389ba28002 instanceof ArrayAccess ? $__internal_68aa442c1d43d3410ea8f958ba9090f3eaa9a76f8de8fc9be4d6c7389ba28002["db"] ?? null : null], 9 => [0 => "text query_time", 1 => _gettext("Queried time"), "extraSpan" => twig_get_attribute(
                    $this->env,
                    $this->source,
                    // line 46
                    $context["record"],
