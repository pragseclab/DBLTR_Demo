...
class __TwigTemplate_8100301760e5bd107506d0150cf582ca617ca1c6d224e05ad55504d07a4acfcc extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (!twig_test_empty($context["database"] ?? null)) {
            ...
            // line 9
            echo PhpMyAdmin\Url::getFromRoute("/server/privileges", ["username" => $context["username"] ?? null, "hostname" => $context["hostname"] ?? null, "dbname" => "", "tablename" => ""]);
            // line 14
            echo "\">\n          '";
            // line 15
            ...
            if (!twig_test_empty($context["table"] ?? null)) {
                ...
                echo "        <em>\n          <a href=\"";
                // line 27
                echo PhpMyAdmin\Url::getFromRoute("/server/privileges", ["username" => $context["username"] ?? null, "hostname" => $context["hostname"] ?? null, "dbname" => $context["dbname"] ?? null, "tablename" => ""]);
                // line 32
                echo "\">\n            ";
                // line 33
        ...
        if (!twig_test_iterable($context["database"] ?? null) && twig_length_filter($this->env, $context["database"] ?? null) > 0 && !($context["is_wildcard"] ?? null)) {
            ...
            echo PhpMyAdmin\Url::getCommon(["db" => twig_replace_filter(
                // line 73
            ...
            if (twig_length_filter($this->env, $context["table"] ?? null) > 0) {
                ...
                echo PhpMyAdmin\Url::getCommon(["db" => twig_replace_filter(
                    ...
                    $context["database"] ?? null,
                    ["\\_" => "_", "\\%" => "%"]
                ), "table" => $context["table"] ?? null, "reload" => true], "&");
                // line 87
                echo "\">\n        ";
                // line 88
                echo twig_escape_filter($this->env, $context["table"] ?? null, "html", null, true);
