...
final class ExceptionComparatorTest extends TestCase
{
    ...
    {
        return [[new Exception(), new Exception()], [new RuntimeException(), new RuntimeException()], [new Exception(), new RuntimeException()]];
    }
    ...
    public function assertEqualsSucceedsProvider()
    {
        ...
        return [[$exception1, $exception1], [$exception1, $exception2], [$exception3, $exception3], [$exception3, $exception4]];
    }
    public function assertEqualsFailsProvider()
    {
        ...
        return [[$exception1, $exception2, $equalMessage], [$exception1, $exception3, $equalMessage], [$exception1, $exception4, $typeMessage], [$exception2, $exception3, $equalMessage], [$exception4, $exception5, $equalMessage]];
    }
    /**
