...
final class SplObjectStorageComparatorTest extends TestCase
{
    ...
    {
        return [[new SplObjectStorage(), new stdClass()], [new stdClass(), new SplObjectStorage()], [new stdClass(), new stdClass()]];
    }
    public function assertEqualsSucceedsProvider()
    {
        ...
        return [[$storage1, $storage1], [$storage1, $storage2], [$storage3, $storage3], [$storage3, $storage4]];
    }
    public function assertEqualsFailsProvider()
    {
        ...
        $storage3->attach($object2);
        $storage3->attach($object1);
        return [[$storage1, $storage2], [$storage1, $storage3], [$storage2, $storage3]];
    }
