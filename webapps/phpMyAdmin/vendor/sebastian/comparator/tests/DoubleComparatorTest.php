...
final class DoubleComparatorTest extends TestCase
{
    ...
    {
        return [[0, 5.0], [5.0, 0], ['5', 4.5], [1200.0, 7.0E-10], [3, \acos(8)], [\acos(8), 3], [\acos(8), \acos(8)]];
    }
    ...
    {
        return [[2.3, 2.3], ['2.3', 2.3], [5.0, 5], [5, 5.0], [5.0, '5'], [1200.0, 1200], [2.3, 2.5, 0.5], [3, 3.05, 0.05], [1200.0, 1201, 1], [(string) (1 / 3), 1 - 2 / 3], [1 / 3, (string) (1 - 2 / 3)]];
    }
    public function assertEqualsFailsProvider()
    {
        return [[2.3, 4.2], ['2.3', 4.2], [5.0, '4'], [5.0, 6], [1200.0, 1201], [2.3, 2.5, 0.2], [3, 3.05, 0.04], [3, \acos(8)], [\acos(8), 3], [\acos(8), \acos(8)]];
    }
    /**
