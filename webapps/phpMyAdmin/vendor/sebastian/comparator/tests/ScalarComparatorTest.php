...
final class ScalarComparatorTest extends TestCase
{
    ...
    {
        return [['string', 'string'], [new ClassWithToString(), 'string'], ['string', new ClassWithToString()], ['string', null], [false, 'string'], [false, true], [null, false], [null, null], ['10', 10], ['', false], ['1', true], [1, true], [0, false], [0.1, '0.1']];
    }
    public function acceptsFailsProvider()
    {
        return [[[], []], ['string', []], [new ClassWithToString(), new ClassWithToString()], [false, new ClassWithToString()], [\tmpfile(), \tmpfile()]];
    }
    public function assertEqualsSucceedsProvider()
    {
        return [['string', 'string'], [new ClassWithToString(), new ClassWithToString()], ['string representation', new ClassWithToString()], [new ClassWithToString(), 'string representation'], ['string', 'STRING', true], ['STRING', 'string', true], ['String Representation', new ClassWithToString(), true], [new ClassWithToString(), 'String Representation', true], ['10', 10], ['', false], ['1', true], [1, true], [0, false], [0.1, '0.1'], [false, null], [false, false], [true, true], [null, null]];
    }
