...
final class ObjectComparatorTest extends TestCase
{
    ...
    {
        return [[new TestClass(), new TestClass()], [new stdClass(), new stdClass()], [new stdClass(), new TestClass()]];
    }
    ...
    public function assertEqualsSucceedsProvider()
    {
        ...
        return [[$object1, $object1], [$object1, $object2], [$book1, $book1], [$book1, $book2], [new Struct(2.3), new Struct(2.5), 0.5]];
    }
    public function assertEqualsFailsProvider()
    {
        ...
        return [[new SampleClass(4, 8, 15), new SampleClass(16, 23, 42), $equalMessage], [$object1, $object2, $equalMessage], [$book1, $book2, $equalMessage], [$book3, $book4, $typeMessage], [new Struct(2.3), new Struct(4.2), $equalMessage, 0.5]];
    }
    /**
