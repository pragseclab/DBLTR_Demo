...
final class StrictUnifiedDiffOutputBuilderTest extends TestCase
{
     ...
     */
    public function testConfiguredDiffGeneration(string $expected, string $from, string $to, array $config = array()) : void
    {
...
', $diff);
    ...
    {
        $builder = new StrictUnifiedDiffOutputBuilder(['fromFile' => 'input.txt', 'toFile' => 'output.txt']);
...
', "A\nX\nV\nY\n1\nA\n2\nA\n3\nA\n4\nA\n8\nA\n9\nA\n5\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\n", "A\nB\nV\nD\n1\nA\n2\nA\n3\nA\n4\nA\n8\nA\n9\nA\n5\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\n", 9999, 99999]];
     ...
     * @return Differ
     */
    private function getDiffer(array $options = array()) : Differ
    {
