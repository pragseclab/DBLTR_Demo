...
class FlattenExceptionTest extends TestCase
{
    ...
    public function testToArray(\Exception $exception, $statusCode)
    {
        ...
        $this->assertEquals(array(array('message' => 'test', 'class' => 'Exception', 'trace' => array(array('namespace' => '', 'short_class' => '', 'class' => '', 'type' => '', 'function' => '', 'file' => 'foo.php', 'line' => 123, 'args' => array())))), $flattened->toArray());
    }
    ...
    public function testArguments()
    {
        ...
        $exception = $this->createException(array((object) array('foo' => 1), new NotFoundHttpException(), $incomplete, $dh, $fh, function () {
        }, array(1, 2), array('foo' => 123), null, true, false, 0, 0.0, '0', '', INF, NAN));
        $flattened = FlattenException::create($exception);
