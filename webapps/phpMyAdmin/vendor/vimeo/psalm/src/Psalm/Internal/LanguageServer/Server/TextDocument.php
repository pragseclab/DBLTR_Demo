...
class TextDocument
{
    ...
    public function __construct(LanguageServer $server, Codebase $codebase, ?int $onchange_line_limit)
    {
        $this->server = $server;
    ...
    public function signatureHelp(TextDocumentIdentifier $textDocument, Position $position) : Promise
    {
        ...
        return new Success(new \LanguageServerProtocol\SignatureHelp([$signature_information], 0, $argument_location[1]));
    }
}