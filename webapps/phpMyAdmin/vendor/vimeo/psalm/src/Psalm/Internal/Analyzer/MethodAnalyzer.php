...
{
    public function __construct(PhpParser\Node\Stmt\ClassMethod $function, SourceAnalyzer $source, ?MethodStorage $storage = null)
    {
     ...
     */
    public static function checkStatic(\Psalm\Internal\MethodIdentifier $method_id, bool $self_call, bool $is_context_dynamic, Codebase $codebase, CodeLocation $code_location, array $suppressed_issues, ?bool &$is_dynamic_this_method = false) : bool
    {
     ...
     *
     */
    public static function checkMethodExists(Codebase $codebase, \Psalm\Internal\MethodIdentifier $method_id, CodeLocation $code_location, array $suppressed_issues, ?string $calling_method_id = null) : ?bool
    {
    ...
    public static function isMethodVisible(\Psalm\Internal\MethodIdentifier $method_id, Context $context, StatementsSource $source) : bool
    {
        $codebase = $source->getCodebase();
     ...
     * @return false|null
     */
    public static function checkMethodSignatureMustOmitReturnType(MethodStorage $method_storage, CodeLocation $code_location) : ?bool
    {
        ...
        if (in_array($cased_method_name, $methodsOfInterest)) {
            if (IssueBuffer::accepts(new MethodSignatureMustOmitReturnType('Method ' . $cased_method_name . ' must not declare a return type', $code_location))) {
                return false;
            }
        }
        return null;
    ...
    public function getMethodId(?string $context_self = null) : \Psalm\Internal\MethodIdentifier
    {
        ...
        return new \Psalm\Internal\MethodIdentifier($context_self ?: (string) $this->source->getFQCLN(), strtolower($function_name));
    }
}