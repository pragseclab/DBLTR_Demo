...
class DataFlowNodeData
{
     ...
     */
    public $column_to;
    public function __construct(string $label, string $entry_path_type, ?string $entry_path_description, int $line_from, int $line_to, string $file_name, string $file_path, string $snippet, string $selected_text, int $from, int $to, int $snippet_from, int $snippet_to, int $column_from, int $column_to)
    {
        $this->label = $label;
