...
class InternalCallMapHandler
{
     ...
     */
    public static function getCallableFromCallMapById(Codebase $codebase, string $method_id, array $args, ?\Psalm\Internal\Provider\NodeDataProvider $nodes) : TCallable
    {
     ...
     *
     */
    public static function getMatchingCallableFromCallMapOptions(Codebase $codebase, array $callables, array $args, ?\Psalm\NodeTypeProvider $nodes, string $method_id) : TCallable
    {
        ...
        foreach ($callables as $possible_callable) {
            ...
            foreach ($args as $argument_offset => $arg) {
                ...
                if (UnionTypeComparator::isContainedBy($codebase, $arg_type, $param_type, true, true, $arg_result) || $arg_result->type_coerced) {
    ...
    public static function getCallablesFromCallMap(string $function_id) : ?array
    {
        ...
        foreach ($call_map_functions as $call_map_function_args) {
            ...
            foreach ($call_map_function_args as $arg_name => $arg_type) {
                ...
                $function_param = new FunctionLikeParameter($arg_name, $by_reference, $param_type, null, null, $optional, false, $variadic);
                if ($out_type) {
