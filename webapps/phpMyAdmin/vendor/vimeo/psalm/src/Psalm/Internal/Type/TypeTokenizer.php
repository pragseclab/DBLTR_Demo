...
class TypeTokenizer
{
     ...
     */
    public const PSALM_RESERVED_WORDS = ['int' => true, 'string' => true, 'float' => true, 'bool' => true, 'false' => true, 'true' => true, 'object' => true, 'empty' => true, 'callable' => true, 'array' => true, 'non-empty-array' => true, 'non-empty-string' => true, 'non-falsy-string' => true, 'iterable' => true, 'null' => true, 'mixed' => true, 'numeric-string' => true, 'class-string' => true, 'callable-string' => true, 'callable-array' => true, 'pure-callable' => true, 'pure-Closure' => true, 'trait-string' => true, 'mysql-escaped-string' => true, 'html-escaped-string' => true, 'lowercase-string' => true, 'non-empty-lowercase-string' => true, 'positive-int' => true, 'boolean' => true, 'integer' => true, 'double' => true, 'real' => true, 'resource' => true, 'void' => true, 'self' => true, 'static' => true, 'scalar' => true, 'numeric' => true, 'no-return' => true, 'never-return' => true, 'never-returns' => true, 'never' => true, 'array-key' => true, 'key-of' => true, 'value-of' => true, 'non-empty-countable' => true, 'list' => true, 'non-empty-list' => true, 'class-string-map' => true, 'open-resource' => true, 'closed-resource' => true, 'associative-array' => true, 'arraylike-object' => true, 'int-mask' => true, 'int-mask-of' => true];
    /**
     ...
     * @psalm-pure
     */
    public static function fixScalarTerms(string $type_string, ?array $php_version = null) : string
    {
    ...
    public static function getFullyQualifiedTokens(string $string_type, Aliases $aliases, ?array $template_type_map = null, ?array $type_aliases = null, ?string $self_fqcln = null, ?string $parent_fqcln = null, bool $allow_assertions = false) : array
    {
        ...
        for ($i = 0, $l = count($type_tokens); $i < $l; ++$i) {
            ...
            if (isset($type_aliases[$string_type_token[0]])) {
                ...
                $type_tokens[$i][0] = \Psalm\Type::getFQCLNFromString($string_type_token[0], $aliases);
            }
        }
