...
class PartialParserVisitor extends PhpParser\NodeVisitorAbstract
{
    ...
    public function __construct(PhpParser\Parser $parser, PhpParser\ErrorHandler\Collecting $error_handler, array $offset_map, string $a_file_contents, string $b_file_contents)
    {
        $this->parser = $parser;
