...
class AtomicTypeComparator
{
     ...
     */
    public static function isContainedBy(Codebase $codebase, Type\Atomic $input_type_part, Type\Atomic $container_type_part, bool $allow_interface_equality = false, bool $allow_float_int_equality = true, ?TypeComparisonResult $atomic_comparison_result = null) : bool
    {
        if (($container_type_part instanceof TTemplateParam || $container_type_part instanceof TNamedObject && isset($container_type_part->extra_types)) && ($input_type_part instanceof TTemplateParam || $input_type_part instanceof TNamedObject && isset($input_type_part->extra_types))) {
            return ObjectComparator::isShallowlyContainedBy($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $atomic_comparison_result);
        }
        ...
        if ($input_type_part instanceof Scalar && $container_type_part instanceof Scalar) {
            return ScalarTypeComparator::isContainedBy($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $allow_float_int_equality, $atomic_comparison_result);
        }
        if ($input_type_part instanceof Type\Atomic\TCallableKeyedArray && $container_type_part instanceof TArray) {
            return ArrayTypeComparator::isContainedBy($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $atomic_comparison_result);
        }
        if ($container_type_part instanceof Type\Atomic\TCallable && $input_type_part instanceof Type\Atomic\TCallable || $container_type_part instanceof Type\Atomic\TClosure && $input_type_part instanceof Type\Atomic\TClosure) {
            return CallableTypeComparator::isContainedBy($codebase, $input_type_part, $container_type_part, $atomic_comparison_result);
        }
        if ($container_type_part instanceof Type\Atomic\TClosure && $input_type_part instanceof TCallable) {
            if (CallableTypeComparator::isContainedBy($codebase, $input_type_part, $container_type_part, $atomic_comparison_result) === false) {
                return false;
            }
            if ($atomic_comparison_result) {
                $atomic_comparison_result->type_coerced = true;
        ...
        if ($input_type_part instanceof Type\Atomic\TCallableObject && $container_type_part instanceof TObject) {
            return true;
        }
        if ($container_type_part instanceof TKeyedArray && $input_type_part instanceof TKeyedArray || $container_type_part instanceof TObjectWithProperties && $input_type_part instanceof TObjectWithProperties) {
            return KeyedArrayComparator::isContainedBy($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $atomic_comparison_result);
        }
        if (($input_type_part instanceof TArray || $input_type_part instanceof TList || $input_type_part instanceof TKeyedArray || $input_type_part instanceof TClassStringMap) && ($container_type_part instanceof TArray || $container_type_part instanceof TList || $container_type_part instanceof TKeyedArray || $container_type_part instanceof TClassStringMap)) {
            return ArrayTypeComparator::isContainedBy($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $atomic_comparison_result);
        }
        if (($input_type_part instanceof TNamedObject || $input_type_part instanceof TTemplateParam && $input_type_part->as->hasObjectType() || $input_type_part instanceof TIterable) && ($container_type_part instanceof TNamedObject || $container_type_part instanceof TTemplateParam && $container_type_part->isObjectType() || $container_type_part instanceof TIterable) && ObjectComparator::isShallowlyContainedBy($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $atomic_comparison_result)) {
            if ($container_type_part instanceof TGenericObject || $container_type_part instanceof TIterable) {
                return GenericTypeComparator::isContainedBy($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $atomic_comparison_result);
            }
            if ($container_type_part instanceof TNamedObject && $input_type_part instanceof TNamedObject && $container_type_part->was_static && !$input_type_part->was_static) {
                if ($atomic_comparison_result) {
                    $atomic_comparison_result->type_coerced = true;
                }
                return false;
        ...
        if ($container_type_part instanceof TTemplateParam && $input_type_part instanceof TTemplateParam) {
            return UnionTypeComparator::isContainedBy($codebase, $input_type_part->as, $container_type_part->as, false, false, $atomic_comparison_result, $allow_interface_equality);
        }
        if ($container_type_part instanceof TTemplateParam) {
            foreach ($container_type_part->as->getAtomicTypes() as $container_as_type_part) {
                if (self::isContainedBy($codebase, $input_type_part, $container_as_type_part, $allow_interface_equality, $allow_float_int_equality, $atomic_comparison_result)) {
                    if ($allow_interface_equality || $input_type_part instanceof TArray && !$input_type_part->type_params[1]->isEmpty() || $input_type_part instanceof TKeyedArray) {
                        return true;
                    }
                }
            }
        ...
        if ($container_type_part instanceof TIterable) {
            if ($input_type_part instanceof TArray || $input_type_part instanceof TKeyedArray || $input_type_part instanceof TList) {
                ...
                foreach ($input_type_part->type_params as $i => $input_param) {
                    ...
                    if (!$input_param->isEmpty() && !UnionTypeComparator::isContainedBy($codebase, $input_param, $container_param, $input_param->ignore_nullable_issues, $input_param->ignore_falsable_issues, $array_comparison_result, $allow_interface_equality) && !$array_comparison_result->type_coerced_from_scalar) {
        ...
        if ($container_type_part instanceof TString || $container_type_part instanceof TScalar) {
            if ($input_type_part instanceof TNamedObject) {
                ...
                if ($codebase->classOrInterfaceExists($input_type_part->value)) {
                    if ($codebase->php_major_version >= 8 && ($input_type_part->value === 'Stringable' || $codebase->classlikes->classExists($input_type_part->value) && $codebase->classlikes->classImplements($input_type_part->value, 'Stringable') || $codebase->classlikes->interfaceExtends($input_type_part->value, 'Stringable'))) {
                        if ($atomic_comparison_result) {
                            $atomic_comparison_result->to_string_cast = true;
                        }
                        return true;
                    }
                    if ($codebase->methods->methodExists(new \Psalm\Internal\MethodIdentifier($input_type_part->value, '__tostring'))) {
                        if ($atomic_comparison_result) {
                            $atomic_comparison_result->to_string_cast = true;
                        }
                        return true;
        ...
        if ($container_type_part instanceof TCallable && ($input_type_part instanceof TLiteralString || $input_type_part instanceof TCallableString || $input_type_part instanceof TArray || $input_type_part instanceof TKeyedArray || $input_type_part instanceof TList || $input_type_part instanceof TNamedObject && $codebase->classOrInterfaceExists($input_type_part->value) && $codebase->methodExists($input_type_part->value . '::__invoke'))) {
            return CallableTypeComparator::isNotExplicitlyCallableTypeCallable($codebase, $input_type_part, $container_type_part, $atomic_comparison_result);
        }
        if ($container_type_part instanceof TObject && $input_type_part instanceof TNamedObject) {
            if ($container_type_part instanceof TObjectWithProperties && $input_type_part->value !== 'stdClass') {
                return KeyedArrayComparator::isContainedByObjectWithProperties($codebase, $input_type_part, $container_type_part, $allow_interface_equality, $atomic_comparison_result);
            }
            return true;
        }
        if ($container_type_part instanceof TNamedObject && $input_type_part instanceof TNamedObject && $container_type_part->was_static && !$input_type_part->was_static) {
     ...
     * Does the input param atomic type match the given param atomic type
     */
    public static function canBeIdentical(Codebase $codebase, Type\Atomic $type1_part, Type\Atomic $type2_part, bool $allow_interface_equality = true) : bool
    {
        if (get_class($type1_part) === TList::class && $type2_part instanceof Type\Atomic\TNonEmptyList || get_class($type2_part) === TList::class && $type1_part instanceof Type\Atomic\TNonEmptyList) {
            return UnionTypeComparator::canExpressionTypesBeIdentical($codebase, $type1_part->type_param, $type2_part->type_param);
        }
        if (get_class($type1_part) === TArray::class && $type2_part instanceof Type\Atomic\TNonEmptyArray || get_class($type2_part) === TArray::class && $type1_part instanceof Type\Atomic\TNonEmptyArray) {
            return UnionTypeComparator::canExpressionTypesBeIdentical($codebase, $type1_part->type_params[0], $type2_part->type_params[0]) && UnionTypeComparator::canExpressionTypesBeIdentical($codebase, $type1_part->type_params[1], $type2_part->type_params[1]);
        }
        $first_comparison_result = new TypeComparisonResult();
        $second_comparison_result = new TypeComparisonResult();
        return AtomicTypeComparator::isContainedBy($codebase, $type1_part, $type2_part, $allow_interface_equality, false, $first_comparison_result) && !$first_comparison_result->to_string_cast || AtomicTypeComparator::isContainedBy($codebase, $type2_part, $type1_part, $allow_interface_equality, false, $second_comparison_result) && !$second_comparison_result->to_string_cast || $first_comparison_result->type_coerced && $second_comparison_result->type_coerced;
    }
}