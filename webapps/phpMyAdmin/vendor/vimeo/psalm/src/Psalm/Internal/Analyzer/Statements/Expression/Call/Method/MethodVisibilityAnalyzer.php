...
class MethodVisibilityAnalyzer
{
     ...
     * @return false|null
     */
    public static function analyze(\Psalm\Internal\MethodIdentifier $method_id, Context $context, StatementsSource $source, CodeLocation $code_location, array $suppressed_issues) : ?bool
    {
        ...
        switch ($visibility) {
            ...
            case ClassLikeAnalyzer::VISIBILITY_PROTECTED:
                ...
                if ($appearing_method_class && $codebase_classlikes->classExtends($appearing_method_class, $context->self)) {
                    return null;
                }
                if ($appearing_method_class && !$codebase_classlikes->classExtends($context->self, $appearing_method_class)) {
