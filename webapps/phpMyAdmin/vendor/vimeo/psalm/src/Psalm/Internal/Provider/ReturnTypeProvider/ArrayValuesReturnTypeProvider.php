    ...
    public static function getFunctionReturnType(FunctionReturnTypeProviderEvent $event) : Type\Union
    {
        ...
        if ($first_arg_array instanceof Type\Atomic\TArray) {
            if ($first_arg_array instanceof Type\Atomic\TNonEmptyArray) {
                return new Type\Union([new Type\Atomic\TNonEmptyList(clone $first_arg_array->type_params[1])]);
            }
            return new Type\Union([new Type\Atomic\TList(clone $first_arg_array->type_params[1])]);
        }
