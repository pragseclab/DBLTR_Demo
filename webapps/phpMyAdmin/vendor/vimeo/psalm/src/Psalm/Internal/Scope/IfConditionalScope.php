...
class IfConditionalScope
{
     ...
     */
    public function __construct(Context $if_context, Context $original_context, array $cond_referenced_var_ids, array $assigned_in_conditional_var_ids, array $entry_clauses)
    {
