...
class TObjectWithProperties extends TObject
{
    ...
    public function __toString() : string
    {
        ...
        $methods_string = implode(', ', array_map(function (string $name) : string {
            return $name . '()';
    ...
    public function toNamespacedString(?string $namespace, array $aliased_classes, ?string $this_class, bool $use_phpdoc_format) : string
    {
        ...
        return 'object{' . implode(', ', array_map(
             ...
             * @param  string|int $name
             */
            function ($name, Union $type) use($namespace, $aliased_classes, $this_class, $use_phpdoc_format) : string {
