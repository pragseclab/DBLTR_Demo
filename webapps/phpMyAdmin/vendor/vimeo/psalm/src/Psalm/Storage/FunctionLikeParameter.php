...
class FunctionLikeParameter
{
     ...
     */
    public $attributes = [];
    public function __construct(string $name, bool $by_ref, ?Type\Union $type = null, ?CodeLocation $location = null, ?CodeLocation $type_location = null, bool $is_optional = true, bool $is_nullable = false, bool $is_variadic = false, ?Type\Union $default_type = null)
    {
        $this->name = $name;
        $this->by_ref = $by_ref;
        $this->type = $type;
