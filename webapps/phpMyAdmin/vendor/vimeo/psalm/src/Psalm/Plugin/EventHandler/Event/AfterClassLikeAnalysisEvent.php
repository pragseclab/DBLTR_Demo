...
class AfterClassLikeAnalysisEvent
{
     ...
     */
    public function __construct(Node\Stmt\ClassLike $stmt, ClassLikeStorage $classlike_storage, StatementsSource $statements_source, Codebase $codebase, array $file_replacements = array())
    {
        $this->stmt = $stmt;
