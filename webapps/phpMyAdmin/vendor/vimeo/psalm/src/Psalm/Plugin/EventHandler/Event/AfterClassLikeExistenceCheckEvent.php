...
class AfterClassLikeExistenceCheckEvent
{
     ...
     */
    public function __construct(string $fq_class_name, CodeLocation $code_location, StatementsSource $statements_source, Codebase $codebase, array $file_replacements = array())
    {
