...
class CodeClimateReport extends Report
{
    public function create() : string
    {
        ...
        $issues_data = \array_map(function (IssueData $issue) : array {
            /**
             ...
             */
            return ['type' => 'issue', 'check_name' => $issue->type, 'description' => $issue->message, 'categories' => [$issue->type], 'severity' => $this->convertSeverity($issue->severity), 'fingerprint' => $this->calculateFingerprint($issue), 'location' => ['path' => $issue->file_path, 'lines' => ['begin' => $issue->from, 'end' => $issue->to]]];
        }, $this->issues_data);
