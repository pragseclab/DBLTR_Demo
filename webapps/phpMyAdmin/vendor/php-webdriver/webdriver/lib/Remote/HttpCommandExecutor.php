...
{
    const DEFAULT_HTTP_HEADERS = array('Content-Type: application/json;charset=UTF-8', 'Accept: application/json');
    /**
    ...
    protected static $commands = array(
        ...
        DriverCommand::SWITCH_TO_PARENT_FRAME => array('method' => 'POST', 'url' => '/session/:sessionId/frame/parent'),
        ...
        DriverCommand::GET_NAMED_COOKIE => array('method' => 'GET', 'url' => '/session/:sessionId/cookie/:name'),
        ...
        DriverCommand::UPLOAD_FILE => array('method' => 'POST', 'url' => '/session/:sessionId/file'),
        // undocumented
        ...
        DriverCommand::STATUS => array('method' => 'GET', 'url' => '/status'),
        ...
        DriverCommand::TAKE_ELEMENT_SCREENSHOT => array('method' => 'GET', 'url' => '/session/:sessionId/element/:id/screenshot'),
        ...
        DriverCommand::CUSTOM_COMMAND => array(),
    );
    /**
     * @var array Will be merged with $commands
     */
    protected static $w3cCompliantCommands = array(DriverCommand::ACCEPT_ALERT => array('method' => 'POST', 'url' => '/session/:sessionId/alert/accept'), DriverCommand::ACTIONS => array('method' => 'POST', 'url' => '/session/:sessionId/actions'), DriverCommand::DISMISS_ALERT => array('method' => 'POST', 'url' => '/session/:sessionId/alert/dismiss'), DriverCommand::EXECUTE_ASYNC_SCRIPT => array('method' => 'POST', 'url' => '/session/:sessionId/execute/async'), DriverCommand::EXECUTE_SCRIPT => array('method' => 'POST', 'url' => '/session/:sessionId/execute/sync'), DriverCommand::FULLSCREEN_WINDOW => array('method' => 'POST', 'url' => '/session/:sessionId/window/fullscreen'), DriverCommand::GET_ACTIVE_ELEMENT => array('method' => 'GET', 'url' => '/session/:sessionId/element/active'), DriverCommand::GET_ALERT_TEXT => array('method' => 'GET', 'url' => '/session/:sessionId/alert/text'), DriverCommand::GET_CURRENT_WINDOW_HANDLE => array('method' => 'GET', 'url' => '/session/:sessionId/window'), DriverCommand::GET_ELEMENT_LOCATION => array('method' => 'GET', 'url' => '/session/:sessionId/element/:id/rect'), DriverCommand::GET_ELEMENT_PROPERTY => array('method' => 'GET', 'url' => '/session/:sessionId/element/:id/property/:name'), DriverCommand::GET_ELEMENT_SIZE => array('method' => 'GET', 'url' => '/session/:sessionId/element/:id/rect'), DriverCommand::GET_WINDOW_HANDLES => array('method' => 'GET', 'url' => '/session/:sessionId/window/handles'), DriverCommand::GET_WINDOW_POSITION => array('method' => 'GET', 'url' => '/session/:sessionId/window/rect'), DriverCommand::GET_WINDOW_SIZE => array('method' => 'GET', 'url' => '/session/:sessionId/window/rect'), DriverCommand::IMPLICITLY_WAIT => array('method' => 'POST', 'url' => '/session/:sessionId/timeouts'), DriverCommand::MAXIMIZE_WINDOW => array('method' => 'POST', 'url' => '/session/:sessionId/window/maximize'), DriverCommand::MINIMIZE_WINDOW => array('method' => 'POST', 'url' => '/session/:sessionId/window/minimize'), DriverCommand::NEW_WINDOW => array('method' => 'POST', 'url' => '/session/:sessionId/window/new'), DriverCommand::SET_ALERT_VALUE => array('method' => 'POST', 'url' => '/session/:sessionId/alert/text'), DriverCommand::SET_SCRIPT_TIMEOUT => array('method' => 'POST', 'url' => '/session/:sessionId/timeouts'), DriverCommand::SET_TIMEOUT => array('method' => 'POST', 'url' => '/session/:sessionId/timeouts'), DriverCommand::SET_WINDOW_SIZE => array('method' => 'POST', 'url' => '/session/:sessionId/window/rect'), DriverCommand::SET_WINDOW_POSITION => array('method' => 'POST', 'url' => '/session/:sessionId/window/rect'));
    /**
     * @var string
     */
    protected $url;
