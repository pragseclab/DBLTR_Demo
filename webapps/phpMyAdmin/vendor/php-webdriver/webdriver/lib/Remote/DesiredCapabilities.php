...
class DesiredCapabilities implements WebDriverCapabilities
{
    ...
    /** @var array */
    private static $ossToW3c = array(WebDriverCapabilityType::PLATFORM => 'platformName', WebDriverCapabilityType::VERSION => 'browserVersion', WebDriverCapabilityType::ACCEPT_SSL_CERTS => 'acceptInsecureCerts', ChromeOptions::CAPABILITY => ChromeOptions::CAPABILITY_W3C);
    public function __construct(array $capabilities = array())
    {
        $this->capabilities = $capabilities;
    }
    public static function createFromW3cCapabilities(array $capabilities = array())
    {
    ...
    public function setJavascriptEnabled($enabled)
    {
        ...
        if ($browser && $browser !== WebDriverBrowserType::HTMLUNIT) {
            throw new Exception('isJavascriptEnabled() is a htmlunit-only option. ' . 'See https://github.com/SeleniumHQ/selenium/wiki/DesiredCapabilities#read-write-capabilities.');
        }
    ...
    {
        if (isset($this->capabilities[ChromeOptions::CAPABILITY]) && $this->capabilities[ChromeOptions::CAPABILITY] instanceof ChromeOptions) {
            $this->capabilities[ChromeOptions::CAPABILITY] = $this->capabilities[ChromeOptions::CAPABILITY]->toArray();
        }
        if (isset($this->capabilities[FirefoxDriver::PROFILE]) && $this->capabilities[FirefoxDriver::PROFILE] instanceof FirefoxProfile) {
    ...
    {
        $allowedW3cCapabilities = ['browserName', 'browserVersion', 'platformName', 'acceptInsecureCerts', 'pageLoadStrategy', 'proxy', 'setWindowRect', 'timeouts', 'strictFileInteractability', 'unhandledPromptBehavior'];
        ...
        if (array_key_exists(ChromeOptions::CAPABILITY, $ossCapabilities)) {
            if (array_key_exists(ChromeOptions::CAPABILITY_W3C, $ossCapabilities)) {
                $w3cCapabilities[ChromeOptions::CAPABILITY_W3C] = new \ArrayObject(array_merge_recursive((array) $ossCapabilities[ChromeOptions::CAPABILITY], (array) $ossCapabilities[ChromeOptions::CAPABILITY_W3C]));
            } else {
        ...
        if (array_key_exists(FirefoxDriver::PROFILE, $ossCapabilities)) {
            ...
            if (!array_key_exists('moz:firefoxOptions', $ossCapabilities) || !array_key_exists('profile', $ossCapabilities['moz:firefoxOptions'])) {
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::ANDROID, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::ANDROID]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::CHROME, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::ANY]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::HTMLUNIT, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::ANY]);
    }
    /**
     * @return static
     */
    ...
    {
        $caps = new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::HTMLUNIT, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::ANY]);
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::IE, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::WINDOWS]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::MICROSOFT_EDGE, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::WINDOWS]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::IPHONE, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::MAC]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::IPAD, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::MAC]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::OPERA, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::ANY]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::SAFARI, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::ANY]);
    }
    /**
     * @return static
     */
    ...
    {
        return new static([WebDriverCapabilityType::BROWSER_NAME => WebDriverBrowserType::PHANTOMJS, WebDriverCapabilityType::PLATFORM => WebDriverPlatform::ANY]);
    }
    /**
     * @param string $key
     * @param mixed $value
