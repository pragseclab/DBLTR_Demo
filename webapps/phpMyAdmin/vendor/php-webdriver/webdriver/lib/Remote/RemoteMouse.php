...
class RemoteMouse implements WebDriverMouse
{
    ...
    public function click(WebDriverCoordinates $where = null)
    {
        if ($this->isW3cCompliant) {
            ...
            $this->executor->execute(DriverCommand::ACTIONS, ['actions' => [['type' => 'pointer', 'id' => 'mouse', 'parameters' => ['pointerType' => 'mouse'], 'actions' => array_merge($moveAction, $this->createClickActions())]]]);
            return $this;
        }
        $this->moveIfNeeded($where);
        $this->executor->execute(DriverCommand::CLICK, ['button' => self::BUTTON_LEFT]);
        return $this;
    }
    /**
    ...
    public function contextClick(WebDriverCoordinates $where = null)
    {
        if ($this->isW3cCompliant) {
            $moveAction = $where ? [$this->createMoveAction($where)] : [];
            $this->executor->execute(DriverCommand::ACTIONS, ['actions' => [['type' => 'pointer', 'id' => 'mouse', 'parameters' => ['pointerType' => 'mouse'], 'actions' => array_merge($moveAction, [['type' => 'pointerDown', 'button' => self::BUTTON_RIGHT], ['type' => 'pointerUp', 'button' => self::BUTTON_RIGHT]])]]]);
            return $this;
        }
        $this->moveIfNeeded($where);
        $this->executor->execute(DriverCommand::CLICK, ['button' => self::BUTTON_RIGHT]);
        return $this;
    }
    /**
     * @param WebDriverCoordinates $where
    ...
    public function doubleClick(WebDriverCoordinates $where = null)
    {
        if ($this->isW3cCompliant) {
            ...
            $this->executor->execute(DriverCommand::ACTIONS, ['actions' => [['type' => 'pointer', 'id' => 'mouse', 'parameters' => ['pointerType' => 'mouse'], 'actions' => array_merge($moveAction, $clickActions, $clickActions)]]]);
            return $this;
        }
        $this->moveIfNeeded($where);
    ...
    {
        if ($this->isW3cCompliant) {
            $this->executor->execute(DriverCommand::ACTIONS, ['actions' => [['type' => 'pointer', 'id' => 'mouse', 'parameters' => ['pointerType' => 'mouse'], 'actions' => [$this->createMoveAction($where), ['type' => 'pointerDown', 'button' => self::BUTTON_LEFT]]]]]);
            return $this;
        }
        $this->moveIfNeeded($where);
    ...
    {
        if ($this->isW3cCompliant) {
            $this->executor->execute(DriverCommand::ACTIONS, ['actions' => [['type' => 'pointer', 'id' => 'mouse', 'parameters' => ['pointerType' => 'mouse'], 'actions' => [$this->createMoveAction($where, $x_offset, $y_offset)]]]]);
            return $this;
        }
        $params = [];
        if ($where !== null) {
    ...
    public function mouseUp(WebDriverCoordinates $where = null)
    {
        if ($this->isW3cCompliant) {
            $moveAction = $where ? [$this->createMoveAction($where)] : [];
            $this->executor->execute(DriverCommand::ACTIONS, ['actions' => [['type' => 'pointer', 'id' => 'mouse', 'parameters' => ['pointerType' => 'mouse'], 'actions' => array_merge($moveAction, [['type' => 'pointerUp', 'button' => self::BUTTON_LEFT]])]]]);
            return $this;
        }
        $this->moveIfNeeded($where);
     ...
     * @return array
     */
    private function createMoveAction(WebDriverCoordinates $where = null, $x_offset = null, $y_offset = null)
    {
        $move_action = [
            'type' => 'pointerMove',
            'duration' => 100,
            // to simulate human delay
    ...
    {
        return [['type' => 'pointerDown', 'button' => self::BUTTON_LEFT], ['type' => 'pointerUp', 'button' => self::BUTTON_LEFT]];
    }
}