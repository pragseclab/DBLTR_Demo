...
class WebDriverExpectedCondition
{
    ...
    {
        return new static(function (WebDriver $driver) use($title) {
    ...
    {
        return new static(function (WebDriver $driver) use($titleRegexp) {
    ...
    {
        return new static(function (WebDriver $driver) use($url) {
    ...
    {
        return new static(function (WebDriver $driver) use($urlRegexp) {
    ...
    {
        return new static(function (WebDriver $driver) use($by) {
            try {
    ...
    {
        return new static(function (WebDriver $driver) use($by, $text) {
            try {
    ...
    {
        return new static(function (WebDriver $driver) use($by, $regexp) {
            try {
    ...
    {
        return new static(function (WebDriver $driver) use($frame_locator) {
            try {
    ...
    public static function elementToBeClickable(WebDriverBy $by)
    {
        ...
        return new static(function (WebDriver $driver) use($visibility_of_element_located) {
    ...
    {
        return new static(function (WebDriver $driver) use($condition) {
            try {
    ...
    {
        return self::elementSelectionStateToBe($element_or_by, true);
    }
    /**
     * An expectation for checking if the given element is selected.
     *
    ...
    public static function elementSelectionStateToBe($element_or_by, $selected)
    {
        if ($element_or_by instanceof WebDriverElement) {
            return new static(function () use($element_or_by, $selected) {
                return $element_or_by->isSelected() === $selected;
            });
        }
        if ($element_or_by instanceof WebDriverBy) {
            return new static(function (WebDriver $driver) use($element_or_by, $selected) {
                try {
    ...
    {
        return new static(function (WebDriver $driver) {
            try {
    ...
    {
        return new static(function (WebDriver $driver) use($expectedNumberOfWindows) {
