        ...
        if (is_string($value)) {
            ...
            if (is_int($value)) {
                ...
                if (is_bool($value)) {
                    ...
                    throw new WebDriverException('The value of the preference should be either a string, int or bool.');
                }
            }
        }
    ...
    public function encode()
    {
        ...
        foreach ($this->extensions_datas as $dirname => $extension_datas) {
            ...
            foreach ($iterator as $item) {
                $target_dir = $temp_dir . DIRECTORY_SEPARATOR . $dirname . DIRECTORY_SEPARATOR . $iterator->getSubPathName();
                if ($item->isDir()) {
                    mkdir($target_dir);
                } else {
        ...
        $dir_prefix = preg_replace('#\\\\#', '\\\\\\\\', $temp_dir . DIRECTORY_SEPARATOR);
