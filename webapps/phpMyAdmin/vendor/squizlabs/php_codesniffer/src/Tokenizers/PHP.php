...
class PHP extends Tokenizer
{
     ...
     * @var array
     */
    public $scopeOpeners = array(T_IF => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDIF => T_ENDIF, T_ELSE => T_ELSE, T_ELSEIF => T_ELSEIF), 'strict' => false, 'shared' => false, 'with' => array(T_ELSE => T_ELSE, T_ELSEIF => T_ELSEIF)), T_TRY => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_CATCH => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_FINALLY => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_ELSE => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDIF => T_ENDIF), 'strict' => false, 'shared' => false, 'with' => array(T_IF => T_IF, T_ELSEIF => T_ELSEIF)), T_ELSEIF => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDIF => T_ENDIF, T_ELSE => T_ELSE, T_ELSEIF => T_ELSEIF), 'strict' => false, 'shared' => false, 'with' => array(T_IF => T_IF, T_ELSE => T_ELSE)), T_FOR => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDFOR => T_ENDFOR), 'strict' => false, 'shared' => false, 'with' => array()), T_FOREACH => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDFOREACH => T_ENDFOREACH), 'strict' => false, 'shared' => false, 'with' => array()), T_INTERFACE => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_FUNCTION => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_CLASS => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_TRAIT => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_USE => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => false, 'shared' => false, 'with' => array()), T_DECLARE => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDDECLARE => T_ENDDECLARE), 'strict' => false, 'shared' => false, 'with' => array()), T_NAMESPACE => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => false, 'shared' => false, 'with' => array()), T_WHILE => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDWHILE => T_ENDWHILE), 'strict' => false, 'shared' => false, 'with' => array()), T_DO => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET), 'strict' => true, 'shared' => false, 'with' => array()), T_SWITCH => array('start' => array(T_OPEN_CURLY_BRACKET => T_OPEN_CURLY_BRACKET, T_COLON => T_COLON), 'end' => array(T_CLOSE_CURLY_BRACKET => T_CLOSE_CURLY_BRACKET, T_ENDSWITCH => T_ENDSWITCH), 'strict' => true, 'shared' => false, 'with' => array()), T_CASE => array('start' => array(T_COLON => T_COLON, T_SEMICOLON => T_SEMICOLON), 'end' => array(T_BREAK => T_BREAK, T_RETURN => T_RETURN, T_CONTINUE => T_CONTINUE, T_THROW => T_THROW, T_EXIT => T_EXIT), 'strict' => true, 'shared' => true, 'with' => array(T_DEFAULT => T_DEFAULT, T_CASE => T_CASE, T_SWITCH => T_SWITCH)), T_DEFAULT => array('start' => array(T_COLON => T_COLON, T_SEMICOLON => T_SEMICOLON), 'end' => array(T_BREAK => T_BREAK, T_RETURN => T_RETURN, T_CONTINUE => T_CONTINUE, T_THROW => T_THROW, T_EXIT => T_EXIT), 'strict' => true, 'shared' => true, 'with' => array(T_CASE => T_CASE, T_SWITCH => T_SWITCH)), T_START_HEREDOC => array('start' => array(T_START_HEREDOC => T_START_HEREDOC), 'end' => array(T_END_HEREDOC => T_END_HEREDOC), 'strict' => true, 'shared' => false, 'with' => array()), T_START_NOWDOC => array('start' => array(T_START_NOWDOC => T_START_NOWDOC), 'end' => array(T_END_NOWDOC => T_END_NOWDOC), 'strict' => true, 'shared' => false, 'with' => array()));
    /**
    ...
    protected function tokenize($string)
    {
        ...
        for ($stackPtr = 0; $stackPtr < $numTokens; $stackPtr++) {
            ...
            */
            if ($tokenIsArray === true && ($token[0] === T_DOC_COMMENT || $token[0] === T_COMMENT && strpos($token[1], '/**') === 0)) {
            ...
            */
            if (PHP_VERSION_ID < 70000 && PHP_VERSION_ID >= 50500 && $tokenIsArray === true && $token[0] === T_YIELD && isset($tokens[$stackPtr + 1]) === true && isset($tokens[$stackPtr + 2]) === true && $tokens[$stackPtr + 1][0] === T_WHITESPACE && $tokens[$stackPtr + 2][0] === T_STRING && strtolower($tokens[$stackPtr + 2][1]) === 'from') {
            ...
            */
            if (PHP_VERSION_ID < 50500 && $tokenIsArray === true && $token[0] === T_STRING && strtolower($token[1]) === 'yield') {
                if (isset($tokens[$stackPtr + 1]) === true && isset($tokens[$stackPtr + 2]) === true && $tokens[$stackPtr + 1][0] === T_WHITESPACE && $tokens[$stackPtr + 2][0] === T_STRING && strtolower($tokens[$stackPtr + 2][1]) === 'from') {
            ...
            */
            if ($tokenIsArray === false && $token[0] === '?') {
                ...
                for ($i = $stackPtr - 1; $i >= 0; $i--) {
                    ...
                    if ($tokenType === T_FUNCTION || $tokenType === T_FN || isset(Util\Tokens::$methodPrefixes[$tokenType]) === true || $tokenType === T_VAR) {
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            echo "\t\t* token {$stackPtr} changed from ? to T_NULLABLE" . PHP_EOL;
                        }
                        $newToken['code'] = T_NULLABLE;
                        ...
                        if (in_array($tokenType, [T_DOUBLE_ARROW, T_OPEN_TAG, T_OPEN_TAG_WITH_ECHO, '=', '{', ';'], true) === true) {
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                echo "\t\t* token {$stackPtr} changed from ? to T_INLINE_THEN" . PHP_EOL;
                            }
                            $newToken['code'] = T_INLINE_THEN;
            ...
            */
            if ($stackPtr > 1 && (is_array($tokens[$stackPtr - 1]) === true && $tokens[$stackPtr - 1][0] === T_PAAMAYIM_NEKUDOTAYIM) && $tokenIsArray === true && $token[0] !== T_STRING && $token[0] !== T_VARIABLE && $token[0] !== T_DOLLAR && isset(Util\Tokens::$emptyTokens[$token[0]]) === false) {
                $newToken = [];
                $newToken['code'] = T_STRING;
                $newToken['type'] = 'T_STRING';
                $newToken['content'] = $token[1];
            ...
            */
            if ($tokenIsArray === true && ($token[0] === T_FUNCTION || $token[0] === T_FN) && $finalTokens[$lastNotEmptyToken]['code'] !== T_USE) {
                if ($token[0] === T_FUNCTION) {
                    ...
                    if ($x < $numTokens && is_array($tokens[$x]) === true && $tokens[$x][0] !== T_NAME_QUALIFIED) {
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                ...
                */
                ...
                if ($parenthesisCloser !== false) {
                    ...
                    if (isset($tokens[$x]) === true && is_array($tokens[$x]) === false && $tokens[$x] === ':') {
                        ...
                        for ($x += 1; $x < $numTokens; $x++) {
                            if (is_array($tokens[$x]) === true && isset(Util\Tokens::$emptyTokens[$tokens[$x][0]]) === true) {
            ...
            */
            if ($tokenIsArray === true && $token[0] === T_STRING && isset($tokens[$stackPtr + 1]) === true && $tokens[$stackPtr + 1] === ':' && (is_array($tokens[$stackPtr - 1]) === false || $tokens[$stackPtr - 1][0] !== T_PAAMAYIM_NEKUDOTAYIM)) {
                $stopTokens = [T_CASE => true, T_SEMICOLON => true, T_OPEN_CURLY_BRACKET => true, T_INLINE_THEN => true];
            ...
            */
            if ($tokenIsArray === true && strpos($token[1], $this->eolChar) !== false) {
                ...
                if ($tokenIsArray === true && $token[0] === T_STRING) {
                    ...
                    $context = [T_OBJECT_OPERATOR => true, T_NULLSAFE_OBJECT_OPERATOR => true, T_FUNCTION => true, T_CLASS => true, T_EXTENDS => true, T_IMPLEMENTS => true, T_NEW => true, T_CONST => true, T_NS_SEPARATOR => true, T_USE => true, T_NAMESPACE => true, T_PAAMAYIM_NEKUDOTAYIM => true];
                    ...
                    if ($this->tokens[$i]['code'] === T_FN && isset($this->tokens[$i + 1]) === true) {
                        ...
                        if (isset($this->tokens[$x]) === true && $this->tokens[$x]['code'] === T_OPEN_PARENTHESIS) {
                            ...
                            if ($this->tokens[$arrow]['code'] === T_DOUBLE_ARROW) {
                                $endTokens = [T_COLON => true, T_COMMA => true, T_SEMICOLON => true, T_CLOSE_PARENTHESIS => true, T_CLOSE_SQUARE_BRACKET => true, T_CLOSE_CURLY_BRACKET => true, T_CLOSE_SHORT_ARRAY => true, T_OPEN_TAG => true, T_CLOSE_TAG => true];
                                $inTernary = false;
                                $lastEndToken = null;
                        ...
                        if ($this->tokens[$i]['code'] === T_OPEN_SQUARE_BRACKET) {
                            ...
                            if ($this->tokens[$i]['code'] === T_STATIC) {
                                ...
                                if ($this->tokens[$i]['code'] === T_TRUE || $this->tokens[$i]['code'] === T_FALSE || $this->tokens[$i]['code'] === T_NULL) {
                                    ...
                                    $context = [T_OBJECT_OPERATOR => true, T_NULLSAFE_OBJECT_OPERATOR => true, T_NS_SEPARATOR => true, T_PAAMAYIM_NEKUDOTAYIM => true];
