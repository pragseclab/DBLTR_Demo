...
class ValidatePEARPackageXML
{
     ...
     */
    private $validRoles = array('data' => true, 'doc' => true, 'ext' => true, 'extsrc' => true, 'php' => true, 'script' => true, 'src' => true, 'test' => true);
    /**
    ...
    protected function checkContents()
    {
         ...
         */
        $srcFiles = (new FileList($this->projectRoot . 'src/', $this->projectRoot, '`\\.(css|fixed|inc|js|php|xml)$`Di'))->getList();
        $testsFiles = (new FileList($this->projectRoot . 'tests/', $this->projectRoot, '`\\.(css|inc|js|php|xml)$`Di'))->getList();
