...
final class CodeCoverage
{
     ...
     * @var string[]
     */
    private $unintentionallyCoveredSubclassesWhitelist = array();
    /**
     ...
     */
    public function stop(bool $append = true, $linesToBeCovered = array(), array $linesToBeUsed = array(), bool $ignoreForceCoversAnnotation = false) : array
    {
     ...
     * @throws RuntimeException
     */
    public function append(array $data, $id = null, bool $append = true, $linesToBeCovered = array(), array $linesToBeUsed = array(), bool $ignoreForceCoversAnnotation = false) : void
    {
        if ($id === null) {
            $id = $this->currentId;
        }
