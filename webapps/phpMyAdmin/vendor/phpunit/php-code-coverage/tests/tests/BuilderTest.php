...
class BuilderTest extends TestCase
{
    ...
    public function testBuildDirectoryStructure()
    {
        ...
        $this->assertEquals(['src' => ['Money.php/f' => [], 'MoneyBag.php/f' => [], 'Foo' => ['Bar' => ['Baz' => ['Foo.php/f' => []]]]]], $method->invoke($this->factory, ["src{$s}Money.php" => [], "src{$s}MoneyBag.php" => [], "src{$s}Foo{$s}Bar{$s}Baz{$s}Foo.php" => []]));
    }
    /**
    ...
    public function reducePathsProvider()
    {
        ...
        foreach ($prefixes as $p) {
            (yield [["Money.php" => []], "{$p}home{$s}sb{$s}Money{$s}", ["{$p}home{$s}sb{$s}Money{$s}Money.php" => []]]);
            (yield [["Money.php" => [], "MoneyBag.php" => []], "{$p}home{$s}sb{$s}Money", ["{$p}home{$s}sb{$s}Money{$s}Money.php" => [], "{$p}home{$s}sb{$s}Money{$s}MoneyBag.php" => []]]);
            (yield [["Money.php" => [], "MoneyBag.php" => [], "Cash.phar{$s}Cash.php" => []], "{$p}home{$s}sb{$s}Money", ["{$p}home{$s}sb{$s}Money{$s}Money.php" => [], "{$p}home{$s}sb{$s}Money{$s}MoneyBag.php" => [], "phar://{$p}home{$s}sb{$s}Money{$s}Cash.phar{$s}Cash.php" => []]]);
        }
    }
}