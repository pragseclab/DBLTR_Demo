...
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
    ...
    protected function getCoverageForBankAccount()
    {
        ...
        $coverage->stop(true, [TEST_FILES_PATH . 'BankAccount.php' => array_merge(range(6, 9), range(20, 25), range(27, 32))]);
        return $coverage;
    }
    ...
    protected function getCoverageForCrashParsing()
    {
        ...
        return new CodeCoverage($this->setUpXdebugStubForCrashParsing(), $filter);
    }
