...
EOF;
    ...
    {
        $values = ['single' => [new \FalsyConstraint(), new \FalsyConstraint(), new \FalsyConstraint()], 'multiple' => [new \FalsyConstraint(), new \FalsyConstraint(), new \FalsyConstraint()]];
    ...
    {
        $values = ['single' => [new \TruthyConstraint()], 'multiple' => [new \FalsyConstraint(), new \TruthyConstraint(), new \FalsyConstraint()]];
        foreach ($values as $key => $constraints) {
            (yield $key => [$constraints]);
        }
    }
