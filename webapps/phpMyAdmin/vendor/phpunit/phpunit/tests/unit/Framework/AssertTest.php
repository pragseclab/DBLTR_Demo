...
XML;
    ...
    {
        $this->assertThat(true, $this->logicalAnd($this->isTrue(), $this->isTrue()));
        $this->expectException(AssertionFailedError::class);
        $this->assertThat(true, $this->logicalAnd($this->isTrue(), $this->isFalse()));
    }
    public function testLogicalOr() : void
    {
        $this->assertThat(true, $this->logicalOr($this->isTrue(), $this->isFalse()));
        $this->expectException(AssertionFailedError::class);
        $this->assertThat(true, $this->logicalOr($this->isFalse(), $this->isFalse()));
    }
    public function testLogicalXor() : void
    {
        $this->assertThat(true, $this->logicalXor($this->isTrue(), $this->isFalse()));
        $this->expectException(AssertionFailedError::class);
        $this->assertThat(true, $this->logicalXor($this->isTrue(), $this->isTrue()));
    }
    ...
    protected function notEqualValues() : array
    {
        ...
        return [
            ...
            [$storage1, $storage2],
            // DOMDocument
            [Xml::load('<root></root>'), Xml::load('<bar/>')],
            [Xml::load('<foo attr1="bar"/>'), Xml::load('<foo attr1="foobar"/>')],
            [Xml::load('<foo> bar </foo>'), Xml::load('<foo />')],
            [Xml::load('<foo xmlns="urn:myns:bar"/>'), Xml::load('<foo xmlns="urn:notmyns:bar"/>')],
            [Xml::load('<foo> bar </foo>'), Xml::load('<foo> bir </foo>')],
    ...
    protected function equalValues() : array
    {
        ...
        return [
            ...
            [$storage1, $storage2],
            // DOMDocument
            [Xml::load('<root></root>'), Xml::load('<root/>')],
            [Xml::load('<root attr="bar"></root>'), Xml::load('<root attr="bar"/>')],
            [Xml::load('<root><foo attr="bar"></foo></root>'), Xml::load('<root><foo attr="bar"/></root>')],
            [Xml::load("<root>\n  <child/>\n</root>"), Xml::load('<root><child/></root>')],
