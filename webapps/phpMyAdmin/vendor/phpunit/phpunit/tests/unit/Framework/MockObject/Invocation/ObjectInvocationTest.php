...
class ObjectInvocationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ObjectInvocation::class, new ObjectInvocation('FooClass', 'FooMethod', ['an_argument'], 'ReturnType', new stdClass()));
    }
    public function testAllowToGetClassNameSetInConstructor() : void
    {
        $invocation = new ObjectInvocation('FooClass', 'FooMethod', ['an_argument'], 'ReturnType', new stdClass());
    ...
    public function testAllowToGetObjectSetInConstructor() : void
    {
        ...
        $invocation = new ObjectInvocation('FooClass', 'FooMethod', ['an_argument'], 'ReturnType', $expectedObject);
    ...
    public function testAllowToGetReturnTypeSetInConstructor() : void
    {
        ...
        $invocation = new ObjectInvocation('FooClass', 'FooMethod', ['an_argument'], $expectedReturnType, new stdClass());
