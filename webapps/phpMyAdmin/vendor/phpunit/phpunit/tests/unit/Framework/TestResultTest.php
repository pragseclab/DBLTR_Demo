...
class TestResultTest extends TestCase
{
    public function testRemoveListenerRemovesOnlyExpectedListener() : void
    {
        ...
        $result->addListener($firstListener);
        $this->assertAttributeEquals([$firstListener, $secondListener, $thirdListener, $firstListener], 'listeners', $result);
        $result->removeListener($firstListener);
        $this->assertAttributeEquals([1 => $secondListener, 2 => $thirdListener], 'listeners', $result);
    }
    public function testAddErrorOfTypeIncompleteTest() : void
    {
        ...
        $listener->expects($this->exactly(2))->method('addIncompleteTest')->with($test, $throwable, $time);
    ...
    {
        return [['CoverageClassTest', false], ['CoverageClassWithoutAnnotationsTest', false], ['CoverageCoversOverridesCoversNothingTest', false], ['CoverageClassNothingTest', true], ['CoverageMethodNothingTest', true]];
    }
    /**
