...
class MockMethodTest extends TestCase
{
    ...
    {
        $method = new MockMethod('ClassName', 'methodName', false, '', '', '', '', '', false, false, null, false);
        $this->assertEquals('methodName', $method->getName());
    }
    public function testFailWhenReturnTypeIsParentButThereIsNoParentClass()
    {
        $method = new MockMethod(\stdClass::class, 'methodName', false, '', '', '', 'parent', '', false, false, null, false);
