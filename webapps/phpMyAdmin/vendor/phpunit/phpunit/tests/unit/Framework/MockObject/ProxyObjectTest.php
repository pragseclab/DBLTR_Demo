...
final class ProxyObjectTest extends TestCase
{
    public function testProxyingWorksForMethodThatReturnsUndeclaredScalarValue() : void
    {
        ...
        $proxy->expects($this->once())->method('returnString');
    ...
    {
        $proxy = $this->createTestProxy(TestProxyFixture::class);
        $proxy->expects($this->once())->method('returnTypedString');
        \assert($proxy instanceof MockObject);
        \assert($proxy instanceof TestProxyFixture);
    ...
    {
        $proxy = $this->createTestProxy(TestProxyFixture::class);
        $proxy->expects($this->once())->method('returnObject');
        \assert($proxy instanceof MockObject);
        \assert($proxy instanceof TestProxyFixture);
    ...
    {
        $proxy = $this->createTestProxy(TestProxyFixture::class);
        $proxy->expects($this->once())->method('returnTypedObject');
        \assert($proxy instanceof MockObject);
        \assert($proxy instanceof TestProxyFixture);
    ...
    {
        $proxy = $this->createTestProxy(TestProxyFixture::class);
        $proxy->expects($this->once())->method('returnObjectOfFinalClass');
        \assert($proxy instanceof MockObject);
        \assert($proxy instanceof TestProxyFixture);
    ...
    {
        $proxy = $this->createTestProxy(TestProxyFixture::class);
        $proxy->expects($this->once())->method('returnTypedObjectOfFinalClass');
        \assert($proxy instanceof MockObject);
        \assert($proxy instanceof TestProxyFixture);
