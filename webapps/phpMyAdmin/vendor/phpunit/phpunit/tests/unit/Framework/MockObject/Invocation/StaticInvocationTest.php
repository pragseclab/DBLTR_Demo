...
class StaticInvocationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(StaticInvocation::class, new StaticInvocation('FooClass', 'FooMethod', ['an_argument'], 'ReturnType'));
    }
    public function testAllowToGetClassNameSetInConstructor() : void
    {
        $invocation = new StaticInvocation('FooClass', 'FooMethod', ['an_argument'], 'ReturnType');
    ...
    public function testAllowToGetReturnTypeSetInConstructor() : void
    {
        ...
        $invocation = new StaticInvocation('FooClass', 'FooMethod', ['an_argument'], $expectedReturnType);
        $this->assertSame($expectedReturnType, $invocation->getReturnType());
    }
    public function testToStringWillReturnEmptyString() : void
    {
        $expectedReturnType = 'string';
        $invocation = new StaticInvocation('FooClass', '__toString', [], '');
        $this->assertSame($expectedReturnType, $invocation->getReturnType());
