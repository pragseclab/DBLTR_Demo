...
class TestTest extends TestCase
{
    ...
    {
        $this->assertArraySubset(['class' => 'FooBarBaz', 'code' => null, 'message' => ''], Test::getExpectedException(\ExceptionTest::class, 'testOne'));
        $this->assertArraySubset(['class' => 'Foo_Bar_Baz', 'code' => null, 'message' => ''], Test::getExpectedException(\ExceptionTest::class, 'testTwo'));
        $this->assertArraySubset(['class' => 'Foo\\Bar\\Baz', 'code' => null, 'message' => ''], Test::getExpectedException(\ExceptionTest::class, 'testThree'));
        $this->assertArraySubset(['class' => 'ほげ', 'code' => null, 'message' => ''], Test::getExpectedException(\ExceptionTest::class, 'testFour'));
        $this->assertArraySubset(['class' => 'Class', 'code' => 1234, 'message' => 'Message'], Test::getExpectedException(\ExceptionTest::class, 'testFive'));
        $this->assertArraySubset(['class' => 'Class', 'code' => 1234, 'message' => 'Message'], Test::getExpectedException(\ExceptionTest::class, 'testSix'));
        $this->assertArraySubset(['class' => 'Class', 'code' => 'ExceptionCode', 'message' => 'Message'], Test::getExpectedException(\ExceptionTest::class, 'testSeven'));
        $this->assertArraySubset(['class' => 'Class', 'code' => 0, 'message' => 'Message'], Test::getExpectedException(\ExceptionTest::class, 'testEight'));
        $this->assertArraySubset(['class' => 'Class', 'code' => \ExceptionTest::ERROR_CODE, 'message' => \ExceptionTest::ERROR_MESSAGE], Test::getExpectedException(\ExceptionTest::class, 'testNine'));
        $this->assertArraySubset(['class' => 'Class', 'code' => null, 'message' => ''], Test::getExpectedException(\ExceptionTest::class, 'testSingleLine'));
        $this->assertArraySubset(['class' => 'Class', 'code' => \My\Space\ExceptionNamespaceTest::ERROR_CODE, 'message' => \My\Space\ExceptionNamespaceTest::ERROR_MESSAGE], Test::getExpectedException(\My\Space\ExceptionNamespaceTest::class, 'testConstants'));
        // Ensure the Class::CONST expression is only evaluated when the constant really exists
        $this->assertArraySubset(['class' => 'Class', 'code' => 'ExceptionTest::UNKNOWN_CODE_CONSTANT', 'message' => 'ExceptionTest::UNKNOWN_MESSAGE_CONSTANT'], Test::getExpectedException(\ExceptionTest::class, 'testUnknownConstants'));
    ...
    {
        $this->assertArraySubset(['message_regex' => '#regex#'], Test::getExpectedException(\ExceptionTest::class, 'testWithRegexMessage'));
        $this->assertArraySubset(['message_regex' => '#regex#'], Test::getExpectedException(\ExceptionTest::class, 'testWithRegexMessageFromClassConstant'));
        $this->assertArraySubset(['message_regex' => 'ExceptionTest::UNKNOWN_MESSAGE_REGEX_CONSTANT'], Test::getExpectedException(\ExceptionTest::class, 'testWithUnknowRegexMessageFromClassConstant'));
    }
    /**
    ...
    {
        return [['testVersionConstraintInvalidPhpConstraint'], ['testVersionConstraintInvalidPhpUnitConstraint']];
    }
    public function testGetRequirementsMergesClassAndMethodDocBlocks() : void
    {
        $expectedAnnotations = ['PHP' => ['version' => '5.4', 'operator' => ''], 'PHPUnit' => ['version' => '3.7', 'operator' => ''], 'OS' => 'WINNT', 'functions' => ['testFuncClass', 'testFuncMethod'], 'extensions' => ['testExtClass', 'testExtMethod']];
    ...
    public function testWithVariousIterableDataProviders() : void
    {
        ...
        $this->assertEquals([['A'], ['B'], ['C'], ['D'], ['E'], ['F'], ['G'], ['H'], ['I']], $dataSets);
    }
    ...
    {
        $this->assertEquals(['Foo', 'ほげ'], Test::getDependencies(\get_class($this), 'methodForTestParseAnnotation'));
    }
    /**
     * @depends Foo
     * @depends ほげ
    ...
    {
        $this->assertEquals(['Bar'], Test::getDependencies(\get_class($this), 'methodForTestParseAnnotationThatIsOnlyOneLine'));
    }
    /** @depends Bar */
    ...
    {
        $this->assertSame([TEST_FILES_PATH . 'CoveredFunction.php' => \range(10, 12)], Test::getLinesToBeCovered('CoverageFunctionParenthesesTest', 'testSomething'));
    }
    public function testFunctionParenthesesAreAllowedWithWhitespace() : void
    {
        $this->assertSame([TEST_FILES_PATH . 'CoveredFunction.php' => \range(10, 12)], Test::getLinesToBeCovered('CoverageFunctionParenthesesWhitespaceTest', 'testSomething'));
    }
    public function testMethodParenthesesAreAllowed() : void
    {
        $this->assertSame([TEST_FILES_PATH . 'CoveredClass.php' => \range(29, 33)], Test::getLinesToBeCovered('CoverageMethodParenthesesTest', 'testSomething'));
    }
    public function testMethodParenthesesAreAllowedWithWhitespace() : void
    {
        $this->assertSame([TEST_FILES_PATH . 'CoveredClass.php' => \range(29, 33)], Test::getLinesToBeCovered('CoverageMethodParenthesesWhitespaceTest', 'testSomething'));
    }
    public function testNamespacedFunctionCanBeCoveredOrUsed() : void
    {
        $this->assertEquals([TEST_FILES_PATH . 'NamespaceCoveredFunction.php' => \range(12, 15)], Test::getLinesToBeCovered(\CoverageNamespacedFunctionTest::class, 'testFunc'));
    }
    public function getLinesToBeCoveredProvider() : array
    {
        return [['CoverageNoneTest', []], ['CoverageClassExtendedTest', \array_merge(\range(27, 44), \range(10, 25))], ['CoverageClassTest', \range(27, 44)], ['CoverageMethodTest', \range(29, 33)], ['CoverageMethodOneLineAnnotationTest', \range(29, 33)], ['CoverageNotPrivateTest', \array_merge(\range(29, 33), \range(35, 39))], ['CoverageNotProtectedTest', \array_merge(\range(29, 33), \range(41, 43))], ['CoverageNotPublicTest', \array_merge(\range(35, 39), \range(41, 43))], ['CoveragePrivateTest', \range(41, 43)], ['CoverageProtectedTest', \range(35, 39)], ['CoveragePublicTest', \range(29, 33)], ['CoverageFunctionTest', \range(10, 12)], ['NamespaceCoverageClassExtendedTest', \array_merge(\range(29, 46), \range(12, 27))], ['NamespaceCoverageClassTest', \range(29, 46)], ['NamespaceCoverageMethodTest', \range(31, 35)], ['NamespaceCoverageNotPrivateTest', \array_merge(\range(31, 35), \range(37, 41))], ['NamespaceCoverageNotProtectedTest', \array_merge(\range(31, 35), \range(43, 45))], ['NamespaceCoverageNotPublicTest', \array_merge(\range(37, 41), \range(43, 45))], ['NamespaceCoveragePrivateTest', \range(43, 45)], ['NamespaceCoverageProtectedTest', \range(37, 41)], ['NamespaceCoveragePublicTest', \range(31, 35)], ['NamespaceCoverageCoversClassTest', \array_merge(\range(43, 45), \range(37, 41), \range(31, 35), \range(24, 26), \range(19, 22), \range(14, 17))], ['NamespaceCoverageCoversClassPublicTest', \range(31, 35)], ['CoverageClassNothingTest', false], ['CoverageMethodNothingTest', false], ['CoverageCoversOverridesCoversNothingTest', \range(29, 33)], ['CoverageMethodNothingCoversMethod', false]];
    }
    ...
    {
        $this->assertSame([TEST_FILES_PATH . '3194.php' => \array_merge(\range(21, 29), \range(13, 19))], Test::getLinesToBeCovered(\Test3194::class, 'testOne'));
    }
}