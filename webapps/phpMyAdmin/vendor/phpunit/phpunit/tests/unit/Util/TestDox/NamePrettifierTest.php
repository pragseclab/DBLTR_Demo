...
class NamePrettifierTest extends TestCase
{
    ...
    public function testPhpDoxIgnoreDataKeys() : void
    {
        $test = new class extends TestCase
        {
            ...
            {
                parent::__construct('testAddition', ['augend' => 1, 'addend' => 2, 'result' => 3]);
            }
            ...
            {
                return ['method' => ['testdox' => ['$augend + $addend = $result']]];
            }
        };
    ...
    public function testPhpDoxArgumentExporting() : void
    {
        $test = new class extends TestCase
        {
            public function __construct()
            {
                parent::__construct('testExport', ['int' => 1234, 'strInt' => '1234', 'float' => 2.123, 'strFloat' => '2.123', 'string' => 'foo', 'bool' => true, 'null' => null]);
            }
            ...
            public function getAnnotations() : array
            {
                return ['method' => ['testdox' => ['$int, $strInt, $float, $strFloat, $string, $bool, $null']]];
            }
        };
    ...
    public function testPhpDoxReplacesLongerVariablesFirst() : void
    {
        $test = new class extends TestCase
        {
            ...
            public function getAnnotations() : array
            {
                return ['method' => ['testdox' => ['$a, "$a", $a$ab, $abc, $abcd, $ab']]];
            }
        };
