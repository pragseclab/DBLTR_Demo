...
EOF;
        ...
        $filterConfiguration = ['include' => ['directory' => [['path' => __DIR__, 'suffix' => '.php', 'prefix' => ''], ['path' => \sprintf('%s/', __DIR__), 'suffix' => '.php', 'prefix' => ''], ['path' => \sprintf('%s/./%s', \dirname(__DIR__), \basename(__DIR__)), 'suffix' => '.php', 'prefix' => ''], ['path' => $directoryPathThatDoesNotExist, 'suffix' => '.php', 'prefix' => '']], 'file' => ['src/foo.php', 'src/bar.php']], 'exclude' => ['directory' => [], 'file' => []]];
