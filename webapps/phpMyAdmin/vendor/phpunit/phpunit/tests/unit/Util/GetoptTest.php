...
class GetoptTest extends TestCase
{
    ...
    public function testItHandlesLongParametesWithValues() : void
    {
        ...
        unset($args[0]);
        $expected = [[['--exec', null], ['--conf', 'config.xml'], ['--optn', null], ['--optn', 'content-of-o']], ['parameter-0', 'parameter-1', 'parameter-2', 'parameter-n']];
    ...
    public function testItHandlesShortParametesWithValues() : void
    {
        ...
        $args = \explode(' ', $command);
        unset($args[0]);
        $expected = [[['x', null], ['c', 'config.xml'], ['o', null], ['o', 'content-of-o']], ['parameter-0', 'parameter-1', 'parameter-2', 'parameter-n']];
