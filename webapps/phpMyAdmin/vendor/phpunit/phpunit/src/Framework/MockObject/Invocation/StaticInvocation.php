...
class StaticInvocation implements Invocation, SelfDescribing
{
     ...
     * @var array
     */
    private static $uncloneableExtensions = array('mysqli' => true, 'SQLite' => true, 'sqlite3' => true, 'tidy' => true, 'xmlwriter' => true, 'xsl' => true);
    /**
     * @var array
     */
    private static $uncloneableClasses = array('Closure', 'COMPersistHelper', 'IteratorIterator', 'RecursiveIteratorIterator', 'SplFileObject', 'PDORow', 'ZipArchive');
    /**
     * @var string
     */
    private $className;
