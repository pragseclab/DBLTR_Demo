...
abstract class Assert
{
    ...
    {
        $constraint = new IsEqual($expected, 0.0, 10, true, false);
        static::assertThat($actual, $constraint, $message);
    }
    /**
    ...
    {
        $constraint = new IsEqual($expected, 0.0, 10, false, true);
        static::assertThat($actual, $constraint, $message);
    }
    /**
    ...
    {
        $constraint = new LogicalNot(new IsEqual($expected, 0.0, 10, true, false));
        static::assertThat($actual, $constraint, $message);
    }
    /**
    ...
    {
        $constraint = new LogicalNot(new IsEqual($expected, 0.0, 10, false, true));
        static::assertThat($actual, $constraint, $message);
    }
    /**
    ...
    {
        $constraint = new LogicalNot(new IsEqual($expected, $delta));
        static::assertThat($actual, $constraint, $message);
    }
    /**
    ...
    {
        static::assertThat($actual, new IsType($expected), $message);
    }
    /**
     * Asserts that an attribute is of a given type.
     *
    ...
    {
        static::assertThat($actual, new LogicalNot(new IsType($expected)), $message);
    }
    /**
