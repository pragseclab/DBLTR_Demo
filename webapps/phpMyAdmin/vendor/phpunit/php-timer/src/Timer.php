...
final class Timer
{
     ...
     * @var int[]
     */
    private static $sizes = array('GB' => 1073741824, 'MB' => 1048576, 'KB' => 1024);
    /**
     * @var int[]
     */
    ...
    {
        return \sprintf('Time: %s, Memory: %s', self::timeSinceStartOfRequest(), self::bytesToString(\memory_get_peak_usage(true)));
    }
}