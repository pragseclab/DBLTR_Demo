...
class ParentCallSpacingSniff extends AbstractControlStructureSpacing
{
    ...
    public function process(File $phpcsFile, $parentPointer) : void
    {
        ...
        $tokensToIgnore = array_merge(Tokens::$assignmentTokens, Tokens::$equalityTokens, Tokens::$booleanOperators, [T_RETURN, T_YIELD, T_YIELD_FROM, T_OPEN_SHORT_ARRAY, T_COLON, T_STRING_CONCAT, T_INLINE_THEN, T_INLINE_ELSE, T_COALESCE]);
