...
class DisallowMultiConstantDefinitionSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $constantPointer) : void
    {
        ...
        foreach ($commaPointers as $commaPointer) {
            $data[$commaPointer] = ['pointerBeforeComma' => TokenHelper::findPreviousEffective($phpcsFile, $commaPointer - 1), 'pointerAfterComma' => TokenHelper::findNextEffective($phpcsFile, $commaPointer + 1)];
        }
