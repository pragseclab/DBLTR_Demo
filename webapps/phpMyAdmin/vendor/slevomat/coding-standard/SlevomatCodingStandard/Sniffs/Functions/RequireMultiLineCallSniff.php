...
class RequireMultiLineCallSniff extends AbstractLineCall
{
    ...
    public function process(File $phpcsFile, $stringPointer) : void
    {
        ...
        $level = 0;
        $pointers = TokenHelper::findNextAll($phpcsFile, [T_COMMA, T_OPEN_PARENTHESIS, T_CLOSE_PARENTHESIS, T_OPEN_SHORT_ARRAY, T_CLOSE_SHORT_ARRAY], $parenthesisOpenerPointer + 1, $parenthesisCloserPointer);
    ...
    private function shouldBeSkipped(File $phpcsFile, int $stringPointer, int $parenthesisCloserPointer) : bool
    {
        ...
        $stringPointersBefore = TokenHelper::findNextAll($phpcsFile, TokenHelper::getOnlyNameTokenCodes(), $firstPointerOnLine, $stringPointer);
        ...
        $stringPointersAfter = TokenHelper::findNextAll($phpcsFile, TokenHelper::getOnlyNameTokenCodes(), $parenthesisCloserPointer + 1, $lastPointerOnLine + 1);
