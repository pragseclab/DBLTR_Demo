...
class TrailingCommaInCallSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $parenthesisOpenerPointer) : void
    {
        ...
        if (!in_array($tokens[$pointerBeforeParenthesisOpener]['code'], array_merge(TokenHelper::getOnlyNameTokenCodes(), [T_VARIABLE, T_ISSET, T_UNSET, T_CLOSE_PARENTHESIS, T_SELF, T_STATIC, T_PARENT]), true)) {
            return;
        }
