...
class RequireMultiLineTernaryOperatorSniff implements Sniff
{
    ...
    private function getEndOfLineBefore(File $phpcsFile, int $pointer) : int
    {
        ...
        while (true) {
            $possibleEndOfLinePointer = TokenHelper::findPrevious($phpcsFile, array_merge([T_WHITESPACE, T_OPEN_TAG, T_OPEN_TAG_WITH_ECHO], TokenHelper::$inlineCommentTokenCodes), $startPointer);
