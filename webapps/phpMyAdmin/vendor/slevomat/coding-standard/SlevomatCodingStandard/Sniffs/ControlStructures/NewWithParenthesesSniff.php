...
class NewWithParenthesesSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $newPointer) : void
    {
        ...
        do {
            $shouldBeOpenParenthesisPointer = TokenHelper::findNext($phpcsFile, [T_OPEN_PARENTHESIS, T_SEMICOLON, T_COMMA, T_INLINE_THEN, T_INLINE_ELSE, T_COALESCE, T_CLOSE_SHORT_ARRAY, T_CLOSE_SQUARE_BRACKET, T_CLOSE_PARENTHESIS, T_DOUBLE_ARROW], $shouldBeOpenParenthesisPointer);
