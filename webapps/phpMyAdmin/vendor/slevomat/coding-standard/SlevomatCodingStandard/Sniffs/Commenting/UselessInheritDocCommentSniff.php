...
class UselessInheritDocCommentSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $docCommentOpenPointer) : void
    {
        ...
        $docCommentOwnerPointer = TokenHelper::findNext($phpcsFile, array_merge(TokenHelper::$functionTokenCodes, TokenHelper::getTypeHintTokenCodes()), $tokens[$docCommentOpenPointer]['comment_closer'] + 1);
