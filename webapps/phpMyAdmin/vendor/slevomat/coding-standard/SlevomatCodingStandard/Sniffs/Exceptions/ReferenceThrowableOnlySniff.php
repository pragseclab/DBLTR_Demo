    ...
    public function process(File $phpcsFile, $openTagPointer) : void
    {
        ...
        foreach ($referencedNames as $referencedName) {
            ...
            if ($tokens[$previousPointer]['code'] === T_BITWISE_OR) {
                $previousPointer = TokenHelper::findPreviousExcluding($phpcsFile, array_merge(TokenHelper::$ineffectiveTokenCodes, TokenHelper::getNameTokenCodes(), [T_BITWISE_OR]), $previousPointer - 1);
            }
