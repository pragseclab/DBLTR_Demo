...
class NegationOperatorSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $pointer) : void
    {
        ...
        $possibleOperandTypes = array_merge(TokenHelper::getOnlyNameTokenCodes(), [T_CONSTANT_ENCAPSED_STRING, T_CLOSE_PARENTHESIS, T_CLOSE_SHORT_ARRAY, T_CLOSE_SQUARE_BRACKET, T_DNUMBER, T_ENCAPSED_AND_WHITESPACE, T_LNUMBER, T_NUM_STRING, T_VARIABLE]);
