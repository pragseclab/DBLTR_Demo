...
class PropertyHelper
{
    ...
    public static function findTypeHint(File $phpcsFile, int $propertyPointer) : ?PropertyTypeHint
    {
        ...
        $typeHintStartPointer = TokenHelper::findPreviousExcluding($phpcsFile, TokenHelper::getTypeHintTokenCodes(), $typeHintEndPointer, $propertyStartPointer) + 1;
        ...
        return new PropertyTypeHint(TokenHelper::getContent($phpcsFile, $typeHintStartPointer, $typeHintEndPointer), $nullabilitySymbolPointer !== null, $nullabilitySymbolPointer ?? $typeHintStartPointer, $typeHintEndPointer);
    }
