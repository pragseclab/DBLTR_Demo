...
class DocCommentHelper
{
    ...
    public static function getDocCommentDescription(File $phpcsFile, int $pointer) : ?array
    {
        ...
        $descriptionStartPointer = TokenHelper::findNextExcluding($phpcsFile, [T_DOC_COMMENT_WHITESPACE, T_DOC_COMMENT_STAR], $docCommentOpenPointer + 1, $tokens[$docCommentOpenPointer]['comment_closer']);
        ...
        $tokenAfterDescriptionPointer = TokenHelper::findNext($phpcsFile, [T_DOC_COMMENT_TAG, T_DOC_COMMENT_CLOSE_TAG], $descriptionStartPointer + 1, $tokens[$docCommentOpenPointer]['comment_closer'] + 1);
    ...
    public static function findDocCommentOpenToken(File $phpcsFile, int $pointer) : ?int
    {
        ...
        $found = TokenHelper::findPrevious($phpcsFile, [T_DOC_COMMENT_CLOSE_TAG, T_SEMICOLON, T_CLOSE_CURLY_BRACKET, T_OPEN_CURLY_BRACKET], $pointer - 1);
