...
abstract class PrettyPrinterAbstract
{
    ...
    protected $precedenceMap = array(
        ...
        BinaryOp\Pow::class => array(0, 1),
        Expr\BitwiseNot::class => array(10, 1),
        Expr\PreInc::class => array(10, 1),
        Expr\PreDec::class => array(10, 1),
        Expr\PostInc::class => array(10, -1),
        Expr\PostDec::class => array(10, -1),
        Expr\UnaryPlus::class => array(10, 1),
        Expr\UnaryMinus::class => array(10, 1),
        Cast\Int_::class => array(10, 1),
        Cast\Double::class => array(10, 1),
        Cast\String_::class => array(10, 1),
        Cast\Array_::class => array(10, 1),
        Cast\Object_::class => array(10, 1),
        Cast\Bool_::class => array(10, 1),
        Cast\Unset_::class => array(10, 1),
        Expr\ErrorSuppress::class => array(10, 1),
        Expr\Instanceof_::class => array(20, 0),
        Expr\BooleanNot::class => array(30, 1),
        BinaryOp\Mul::class => array(40, -1),
        BinaryOp\Div::class => array(40, -1),
        BinaryOp\Mod::class => array(40, -1),
        BinaryOp\Plus::class => array(50, -1),
        BinaryOp\Minus::class => array(50, -1),
        BinaryOp\Concat::class => array(50, -1),
        BinaryOp\ShiftLeft::class => array(60, -1),
        BinaryOp\ShiftRight::class => array(60, -1),
        BinaryOp\Smaller::class => array(70, 0),
        BinaryOp\SmallerOrEqual::class => array(70, 0),
        BinaryOp\Greater::class => array(70, 0),
        BinaryOp\GreaterOrEqual::class => array(70, 0),
        BinaryOp\Equal::class => array(80, 0),
        BinaryOp\NotEqual::class => array(80, 0),
        BinaryOp\Identical::class => array(80, 0),
        BinaryOp\NotIdentical::class => array(80, 0),
        BinaryOp\Spaceship::class => array(80, 0),
        BinaryOp\BitwiseAnd::class => array(90, -1),
        BinaryOp\BitwiseXor::class => array(100, -1),
        BinaryOp\BitwiseOr::class => array(110, -1),
        BinaryOp\BooleanAnd::class => array(120, -1),
        BinaryOp\BooleanOr::class => array(130, -1),
        BinaryOp\Coalesce::class => array(140, 1),
        Expr\Ternary::class => array(150, 0),
        // parser uses %left for assignments, but they really behave as %right
        Expr\Assign::class => array(160, 1),
        Expr\AssignRef::class => array(160, 1),
        AssignOp\Plus::class => array(160, 1),
        AssignOp\Minus::class => array(160, 1),
        AssignOp\Mul::class => array(160, 1),
        AssignOp\Div::class => array(160, 1),
        AssignOp\Concat::class => array(160, 1),
        AssignOp\Mod::class => array(160, 1),
        AssignOp\BitwiseAnd::class => array(160, 1),
        AssignOp\BitwiseOr::class => array(160, 1),
        AssignOp\BitwiseXor::class => array(160, 1),
        AssignOp\ShiftLeft::class => array(160, 1),
        AssignOp\ShiftRight::class => array(160, 1),
        AssignOp\Pow::class => array(160, 1),
        AssignOp\Coalesce::class => array(160, 1),
        Expr\YieldFrom::class => array(165, 1),
        Expr\Print_::class => array(168, 1),
        BinaryOp\LogicalAnd::class => array(170, -1),
        BinaryOp\LogicalXor::class => array(180, -1),
        BinaryOp\LogicalOr::class => array(190, -1),
        Expr\Include_::class => array(200, -1),
    );
