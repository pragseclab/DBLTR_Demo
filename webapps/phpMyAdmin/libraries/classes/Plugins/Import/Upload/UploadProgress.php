...
class UploadProgress implements UploadInterface
{
    ...
    public static function getUploadStatus($id)
    {
        ...
        if (!array_key_exists($id, $_SESSION[$SESSION_KEY])) {
            $_SESSION[$SESSION_KEY][$id] = ['id' => $id, 'finished' => false, 'percent' => 0, 'total' => 0, 'complete' => 0, 'plugin' => self::getIdKey()];
        }
        ...
        if ($status) {
            ...
            $ret = ['id' => $id, 'finished' => true, 'percent' => 100, 'total' => $ret['total'], 'complete' => $ret['total'], 'plugin' => self::getIdKey()];
        }
