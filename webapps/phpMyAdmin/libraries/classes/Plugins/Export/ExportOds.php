...
class ExportOds extends ExportPlugin
{
    ...
    public function exportFooter()
    {
        ...
        return $this->export->outputHandler(OpenDocument::create('application/vnd.oasis.opendocument.spreadsheet', $GLOBALS['ods_buffer']));
    }
    /**
