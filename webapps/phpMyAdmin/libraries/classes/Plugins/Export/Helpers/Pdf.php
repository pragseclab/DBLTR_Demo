...
class Pdf extends PdfLib
{
    ...
    public function Header()
    {
        ...
        if (!isset($this->headerset[$this->page])) {
            ...
            $this->Cell(0, $this->FontSizePt, __('Database:') . ' ' . $this->dbAlias . ',  ' . __('Table:') . ' ' . $this->tableAlias . ',  ' . __('Purpose:') . ' ' . $this->purpose, 0, 1, 'L');
            $l = $this->lMargin;
    ...
    public function getTriggers($db, $table)
    {
        ...
        if ($triggers === []) {
            return;
            //prevents printing blank trigger list for any table
        }
        unset($this->tablewidths, $this->colTitles, $this->titleWidth, $this->colFits, $this->displayColumn, $this->colAlign);
        /**
