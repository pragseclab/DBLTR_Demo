...
class ExportPhparray extends ExportPlugin
{
    ...
    {
        $this->export->outputHandler('<?php' . $GLOBALS['crlf'] . '/**' . $GLOBALS['crlf'] . ' * Export to PHP Array plugin for PHPMyAdmin' . $GLOBALS['crlf'] . ' * @version ' . PMA_VERSION . $GLOBALS['crlf'] . ' */' . $GLOBALS['crlf'] . $GLOBALS['crlf']);
        return true;
    }
    /**
    ...
    public function exportDBHeader($db, $db_alias = '')
    {
        ...
        $this->export->outputHandler('/**' . $GLOBALS['crlf'] . ' * Database ' . $this->commentString(Util::backquote($db_alias)) . $GLOBALS['crlf'] . ' */' . $GLOBALS['crlf']);
        return true;
    }
    /**
    ...
    public function exportData($db, $table, $crlf, $error_url, $sql_query, array $aliases = array())
    {
        ...
        $buffer .= $crlf . '/* ' . $this->commentString(Util::backquote($db_alias)) . '.' . $this->commentString(Util::backquote($table_alias)) . ' */' . $crlf;
