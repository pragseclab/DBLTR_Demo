...
abstract class SubstringTransformationsPlugin extends TransformationsPlugin
{
    ...
    public function applyTransformation($buffer, array $options = [], ?stdClass $meta = null)
    {
        ...
        if ($options[1] !== 'all') {
            $newtext = mb_substr($buffer, $options[0], $options[1]);
        } else {
