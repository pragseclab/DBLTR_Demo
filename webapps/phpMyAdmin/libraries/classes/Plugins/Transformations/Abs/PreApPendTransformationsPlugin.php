...
abstract class PreApPendTransformationsPlugin extends TransformationsPlugin
{
    ...
    {
        return __('Prepends and/or Appends text to a string. First option is text' . ' to be prepended, second is appended (enclosed in single' . ' quotes, default empty string).');
    }
    /**
    ...
    public function applyTransformation($buffer, array $options = [], ?stdClass $meta = null)
    {
        ...
        return htmlspecialchars($options[0]) . htmlspecialchars($buffer) . htmlspecialchars($options[1]);
    }
    /* ~~~~~~~~~~~~~~~~~~~~ Getters and Setters ~~~~~~~~~~~~~~~~~~~~ */
    /**
