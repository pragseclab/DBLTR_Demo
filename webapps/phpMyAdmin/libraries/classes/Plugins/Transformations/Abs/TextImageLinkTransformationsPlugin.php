...
abstract class TextImageLinkTransformationsPlugin extends TransformationsPlugin
{
    ...
    {
        return __('Displays an image and a link; the column contains the filename. The' . ' first option is a URL prefix like "https://www.example.com/". The' . ' second and third options are the width and the height in pixels.');
    }
    /**
    ...
    public function applyTransformation($buffer, array $options = [], ?stdClass $meta = null)
    {
        ...
        return $template->render('plugins/text_image_link_transformations', ['url' => $url, 'width' => (int) $options[1], 'height' => (int) $options[2], 'buffer' => $buffer]);
    }
    /* ~~~~~~~~~~~~~~~~~~~~ Getters and Setters ~~~~~~~~~~~~~~~~~~~~ */
    /**
