...
abstract class DateFormatTransformationsPlugin extends TransformationsPlugin
{
    ...
    public function applyTransformation($buffer, array $options = [], ?stdClass $meta = null)
    {
        ...
        if ($timestamp >= 0) {
            ...
            return '<dfn onclick="alert(\'' . Sanitize::jsFormat($source, false) . '\');" title="' . htmlspecialchars((string) $source) . '">' . htmlspecialchars((string) $text) . '</dfn>';
        }
