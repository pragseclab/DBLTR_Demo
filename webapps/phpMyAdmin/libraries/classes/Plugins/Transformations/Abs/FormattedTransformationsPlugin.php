...
abstract class FormattedTransformationsPlugin extends TransformationsPlugin
{
    ...
    {
        return __('Displays the contents of the column as-is, without running it' . ' through htmlspecialchars(). That is, the column is assumed' . ' to contain valid HTML.');
    }
    /**
    ...
    {
        return '<iframe srcdoc="' . strtr($buffer, '"', '\'') . '" sandbox=""></iframe>';
    }
    /* ~~~~~~~~~~~~~~~~~~~~ Getters and Setters ~~~~~~~~~~~~~~~~~~~~ */
    /**
