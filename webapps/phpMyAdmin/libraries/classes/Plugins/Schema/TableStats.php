...
abstract class TableStats
{
    ...
    {
        global $dbi;
        $result = $dbi->query('SHOW INDEX FROM ' . Util::backquote($this->tableName) . ';', DatabaseInterface::CONNECT_USER, DatabaseInterface::QUERY_STORE);
    ...
    {
        return ($this->tableDimension ? sprintf('%.0fx%0.f', $this->width, $this->heightCell) : '') . ' ' . $this->tableName;
    }
}