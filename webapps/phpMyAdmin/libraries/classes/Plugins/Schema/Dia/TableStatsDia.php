...
class TableStatsDia extends TableStats
{
    ...
    {
        ExportRelationSchema::dieSchema($this->pageNumber, 'DIA', sprintf(__('The %s table doesn\'t exist!'), $this->tableName));
    }
    /**
     * Do draw the table
     *
    ...
    public function tableDraw($showColor)
    {
        ...
        $this->diagram->writeRaw('<dia:attribute name="obj_pos">
        ...
        foreach ($this->fields as $field) {
            $this->diagram->writeRaw('<dia:composite type="table_attribute">
                    <dia:attribute name="name">
            ...
            $this->diagram->writeRaw('<dia:attribute name="primary_key">
                    <dia:boolean val="' . $pm . '"/>
                </dia:attribute>
