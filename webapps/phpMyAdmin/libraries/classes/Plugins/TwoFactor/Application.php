...
class Application extends TwoFactorPlugin
{
    ...
    public function check()
    {
        ...
        $this->provided = true;
        return $this->google2fa->verifyKey($this->twofactor->config['settings']['secret'], $_POST['2fa_code']);
    }
    /**
    ...
    public function setup()
    {
        ...
        $inlineUrl = $this->google2fa->getQRCodeInline('phpMyAdmin (' . $this->getAppId(false) . ')', $this->twofactor->user, $secret);
        return $this->template->render('login/twofactor/application_configure', ['image' => $inlineUrl, 'secret' => $secret, 'has_imagick' => extension_loaded('imagick')]);
    }
    /**
