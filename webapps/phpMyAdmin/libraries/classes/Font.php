...
class Font
{
    ...
    public function getCharLists() : array
    {
        ...
        $charLists[] = ['chars' => ['a', 'b', 'd', 'e', 'g', 'h', 'n', 'o', 'p', 'q', 'u', 'L', '0', '2', '3', '4', '5', '6', '7', '8', '9'], 'modifier' => 0.5600000000000001];
        //FTZ
     ...
     * @access public
     */
    public function getStringWidth(string $text, string $font, int $fontSize, ?array $charLists = null) : int
    {
        ...
        foreach ($charLists as $charList) {
            $count += (mb_strlen($text) - mb_strlen(str_replace($charList['chars'], '', $text))) * $charList['modifier'];
        }
