...
class UserPreferences
{
    ...
    public function redirect($file_name, $params = null, $hash = null)
    {
        ...
        Core::sendHeaderLocation('./' . $file_name . Url::getCommonRaw($url_params, strpos($file_name, '?') === false ? '?' : '&') . $hash);
    }
    /**
    ...
    public function autoloadGetHeader()
    {
        ...
        return $this->template->render('preferences/autoload', ['hidden_inputs' => Url::getHiddenInputs(), 'return_url' => $return_url]);
    }
}