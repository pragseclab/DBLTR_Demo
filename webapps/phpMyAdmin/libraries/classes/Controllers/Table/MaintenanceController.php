...
final class MaintenanceController extends AbstractController
{
     ...
     * @param string   $table
     */
    public function __construct($response, Template $template, $db, $table, Maintenance $model)
    {
    ...
    public function check() : void
    {
        ...
        $this->render('table/maintenance/check', ['message' => $message, 'rows' => $rows, 'indexes_problems' => $indexesProblems]);
    }
