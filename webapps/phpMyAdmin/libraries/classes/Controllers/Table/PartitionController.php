...
final class PartitionController extends AbstractController
{
    ...
    public function analyze() : void
    {
        ...
        $message = Generator::getMessage(__('Your SQL query has been executed successfully.'), $query, 'success');
        $this->render('table/partition/analyze', ['partition_name' => $partitionName, 'message' => $message, 'rows' => $rows]);
    }
    public function check() : void
    {
        ...
        $message = Generator::getMessage(__('Your SQL query has been executed successfully.'), $query, 'success');
        $this->render('table/partition/check', ['partition_name' => $partitionName, 'message' => $message, 'rows' => $rows]);
    }
    public function drop() : void
    {
        ...
        if ($result) {
            ...
            $message = Generator::getMessage(__('Error'), $query, 'error');
        }
    ...
    public function optimize() : void
    {
        ...
        $message = Generator::getMessage(__('Your SQL query has been executed successfully.'), $query, 'success');
        $this->render('table/partition/optimize', ['partition_name' => $partitionName, 'message' => $message, 'rows' => $rows]);
    }
    ...
    public function repair() : void
    {
        ...
        $message = Generator::getMessage(__('Your SQL query has been executed successfully.'), $query, 'success');
        $this->render('table/partition/repair', ['partition_name' => $partitionName, 'message' => $message, 'rows' => $rows]);
    }
