...
final class GisVisualizationController extends AbstractController
{
    ...
    public function index() : void
    {
        ...
        $this->addScriptFiles(['vendor/openlayers/OpenLayers.js', 'vendor/jquery/jquery.svg.js', 'table/gis_visualization.js']);
        ...
        $downloadUrl = Url::getFromRoute('/table/gis-visualization', array_merge($url_params, ['saveToFile' => true, 'session_max_rows' => $rows, 'pos' => $pos]));
        $html = $this->template->render('table/gis_visualization/gis_visualization', ['url_params' => $url_params, 'download_url' => $downloadUrl, 'label_candidates' => $labelCandidates, 'spatial_candidates' => $spatialCandidates, 'visualization_settings' => $visualizationSettings, 'sql_query' => $sqlQuery, 'visualization' => $this->visualization->toImage('svg'), 'draw_ol' => $this->visualization->asOl(), 'theme_image_path' => $PMA_Theme->getImgPath()]);
