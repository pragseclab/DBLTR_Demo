...
class SqlController extends AbstractController
{
    ...
    public function getEnumValues() : void
    {
        ...
        $dropdown = $this->template->render('sql/enum_column_dropdown', ['values' => $values, 'selected_values' => [$curr_value]]);
        $this->response->addJSON('dropdown', $dropdown);
    }
    /**
    ...
    public function getSetValues() : void
    {
        ...
        $select = $this->template->render('sql/set_column', ['values' => $values, 'current_values' => $convertedCurrentValue]);
    ...
    {
        global $cfg;
        $bookmark = Bookmark::createBookmark($this->dbi, $cfg['Server']['user'], $_POST['bkm_fields'], isset($_POST['bkm_all_users']) && $_POST['bkm_all_users'] === 'true');
        $result = null;
