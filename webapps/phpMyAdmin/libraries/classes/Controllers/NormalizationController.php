...
class NormalizationController extends AbstractController
{
    ...
    public function index() : void
    {
        ...
        if (isset($_POST['getColumns'])) {
            ...
            $html .= $this->normalization->getHtmlForColumnsList($db, $table, _pgettext('string types', 'String'));
            echo $html;
            return;
        }
        ...
        if (isset($_POST['repeatingColumns'])) {
            ...
            $res = $this->normalization->moveRepeatingGroup($repeatingColumns, $primary_columns, $newTable, $newColumn, $table, $db);
            $this->response->addJSON($res);
            return;
        }
