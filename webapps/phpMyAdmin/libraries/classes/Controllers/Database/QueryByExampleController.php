...
class QueryByExampleController extends AbstractController
{
    ...
    public function index() : void
    {
        ...
        if ($cfgRelation['savedsearcheswork']) {
            ...
            $savedSearch->setUsername($GLOBALS['cfg']['Server']['user'])->setDbname($db);
            ...
            if (isset($_POST['action'])) {
                ...
                if ($_POST['action'] === 'create') {
                    $saveResult = $savedSearch->setId(null)->setCriterias($_POST)->save();
                } elseif ($_POST['action'] === 'update') {
                    $saveResult = $savedSearch->setCriterias($_POST)->save();
        ...
        $this->render('database/qbe/index', ['url_params' => $url_params, 'has_message_to_display' => $hasMessageToDisplay, 'selection_form_html' => $databaseQbe->getSelectionForm()]);
    }
}