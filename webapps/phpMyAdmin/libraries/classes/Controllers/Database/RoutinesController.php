...
class RoutinesController extends AbstractController
{
    ...
    public function index() : void
    {
        ...
        $this->render('database/routines/index', ['db' => $db, 'table' => $table, 'items' => $items, 'rows' => $rows, 'select_all_arrow_src' => $PMA_Theme->getImgPath() . 'arrow_' . $text_dir . '.png', 'has_privilege' => Util::currentUserHasPrivilege('CREATE ROUTINE', $db, $table)]);
    }
}