...
class ServersController extends AbstractController
{
    ...
    public function index(array $params) : string
    {
        ...
        $page = ob_get_clean();
        return $this->template->render('setup/servers/index', ['formset' => $params['formset'] ?? '', 'pages' => $pages, 'has_server' => $hasServer, 'mode' => $params['mode'], 'server_id' => $id, 'server_dsn' => $this->config->getServerDSN($id), 'page' => $page]);
    }
    /**
     * @param array $params Request parameters
     */
