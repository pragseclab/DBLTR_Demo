...
class ChangeLogController extends AbstractController
{
    public function index() : void
    {
        ...
        if (!@is_readable($filename)) {
            printf(__('The %s file is not available on this system, please visit ' . '%s for more information.'), $filename, '<a href="https://www.phpmyadmin.net/">phpmyadmin.net</a>');
            return;
        }
        ...
        $replaces = [
            ...
            '/([0-9]+)\\.([0-9]+)\\.([0-9]+)\\.0 (\\([0-9-]+\\))/' => '<a id="\\1_\\2_\\3"></a>' . '<a href="url.php?url=' . $github_url . 'commits/RELEASE_\\1_\\2_\\3">' . '\\1.\\2.\\3.0 \\4</a>',
            '/([0-9]+)\\.([0-9]+)\\.([0-9]+)\\.([1-9][0-9]*) (\\([0-9-]+\\))/' => '<a id="\\1_\\2_\\3_\\4"></a>' . '<a href="url.php?url=' . $github_url . 'commits/RELEASE_\\1_\\2_\\3_\\4">' . '\\1.\\2.\\3.\\4 \\5</a>',
        ...
        echo $this->template->render('changelog', ['changelog' => preg_replace(array_keys($replaces), $replaces, $changelog)]);
    }
}