...
class FeaturesController extends AbstractController
{
    ...
    public function index() : void
    {
        ...
        $this->render('preferences/forms/main', ['error' => $error ? $error->getDisplay() : '', 'has_errors' => $formDisplay->hasErrors(), 'errors' => $formErrors ?? null, 'form' => $formDisplay->getDisplay(true, true, true, Url::getFromRoute('/preferences/features'), ['server' => $server])]);
