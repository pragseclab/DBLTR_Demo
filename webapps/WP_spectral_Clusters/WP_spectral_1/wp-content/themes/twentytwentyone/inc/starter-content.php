...
function twenty_twenty_one_get_starter_content()
{
    ...
    $starter_content = array(
        ...
        'posts' => array('front' => array('post_type' => 'page', 'post_title' => esc_html_x('Create your website with blocks', 'Theme starter content', 'twentytwentyone'), 'post_content' => '
        ...
        'nav_menus' => array(
            ...
            'footer' => array('name' => esc_html__('Secondary menu', 'twentytwentyone'), 'items' => array('link_facebook', 'link_twitter', 'link_instagram', 'link_email')),
        ),
    );
    /**
