...
class WP_REST_Themes_Controller extends WP_REST_Controller
{
    ...
    public function get_item_permissions_check($request)
    {
        ...
        error_log('Removed function called get_item_permissions_check:70@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_3/wp-includes/rest-api/endpoints/class-wp-rest-themes-controller.php');
        die();
    }
    /**
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("check_read_active_theme_permission") from ("/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_3/wp-includes/rest-api/endpoints/class-wp-rest-themes-controller.php at line 89")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called check_read_active_theme_permission:89@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_3/wp-includes/rest-api/endpoints/class-wp-rest-themes-controller.php');
        die();
    }
    /**
    ...
    public function get_item($request)
    {
        ...
        error_log('Removed function called get_item:109@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_3/wp-includes/rest-api/endpoints/class-wp-rest-themes-controller.php');
        die();
    }
    /**
    ...
    public function get_items($request)
    {
        ...
        error_log('Removed function called get_items:126@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_3/wp-includes/rest-api/endpoints/class-wp-rest-themes-controller.php');
        die();
    }
    /**
    ...
    public function prepare_item_for_response($theme, $request)
    {
        ...
        $plain_field_mappings = array('requires_php' => 'RequiresPHP', 'requires_wp' => 'RequiresWP', 'textdomain' => 'TextDomain', 'version' => 'Version');
        ...
        $rich_field_mappings = array('author' => 'Author', 'author_uri' => 'AuthorURI', 'description' => 'Description', 'name' => 'Name', 'tags' => 'Tags', 'theme_uri' => 'ThemeURI');
    ...
    {
        return array('self' => array('href' => rest_url(sprintf('%s/%s/%s', $this->namespace, $this->rest_base, $theme->get_stylesheet()))), 'collection' => array('href' => rest_url(sprintf('%s/%s', $this->namespace, $this->rest_base))));
    }
    /**
    ...
    {
        $query_params = array('status' => array('description' => __('Limit result set to themes assigned one or more statuses.'), 'type' => 'array', 'items' => array('enum' => array('active', 'inactive'), 'type' => 'string')));
        /**
