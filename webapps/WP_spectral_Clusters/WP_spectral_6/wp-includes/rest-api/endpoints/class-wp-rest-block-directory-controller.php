...
class WP_REST_Block_Directory_Controller extends WP_REST_Controller
{
    ...
    public function get_items_permissions_check($request)
    {
        ...
        error_log('Removed function called get_items_permissions_check:45@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php');
        die();
    }
    /**
    ...
    public function get_items($request)
    {
        ...
        error_log('Removed function called get_items:61@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php');
        die();
    }
    /**
    ...
    public function prepare_item_for_response($plugin, $request)
    {
        ...
        error_log('Removed function called prepare_item_for_response:92@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php');
        die();
    }
    /**
    ...
    protected function prepare_links($plugin)
    {
        ...
        error_log('Removed function called prepare_links:115@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php');
        die();
    }
    /**
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("find_plugin_for_slug") from ("/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php at line 133")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called find_plugin_for_slug:133@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php');
        die();
    }
    /**
    ...
    public function get_item_schema()
    {
        ...
        error_log('Removed function called get_item_schema:150@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php');
        die();
    }
    /**
    ...
    public function get_collection_params()
    {
        ...
        error_log('Removed function called get_collection_params:165@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_6/wp-includes/rest-api/endpoints/class-wp-rest-block-directory-controller.php');
        die();
    }
}