...
function _register_core_block_patterns_and_categories()
{
    ...
    if ($should_register_core_patterns) {
        $core_block_patterns = array('media-text-nature', 'two-images-gallery', 'three-columns-media-text', 'quote', 'large-header-left', 'large-header-text-button', 'media-text-art', 'text-two-columns-title', 'three-columns-text', 'text-two-columns-title-offset', 'heading', 'three-images-gallery', 'text-two-columns', 'media-text-arquitecture', 'two-buttons');
        foreach ($core_block_patterns as $core_block_pattern) {
            register_block_pattern('core/' . $core_block_pattern, require __DIR__ . '/block-patterns/' . $core_block_pattern . '.php');
        }
    }
