...
abstract class WP_REST_Controller
{
    ...
    public function get_items_permissions_check($request)
    {
        ...
        error_log('Removed function called get_items_permissions_check:64@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function get_items($request)
    {
        ...
        error_log('Removed function called get_items:81@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function get_item_permissions_check($request)
    {
        ...
        error_log('Removed function called get_item_permissions_check:98@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function get_item($request)
    {
        ...
        error_log('Removed function called get_item:115@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function create_item_permissions_check($request)
    {
        ...
        error_log('Removed function called create_item_permissions_check:132@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function create_item($request)
    {
        ...
        error_log('Removed function called create_item:149@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function update_item_permissions_check($request)
    {
        ...
        error_log('Removed function called update_item_permissions_check:166@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function update_item($request)
    {
        ...
        error_log('Removed function called update_item:183@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function delete_item_permissions_check($request)
    {
        ...
        error_log('Removed function called delete_item_permissions_check:200@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function delete_item($request)
    {
        ...
        error_log('Removed function called delete_item:217@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    protected function prepare_item_for_database($request)
    {
        ...
        error_log('Removed function called prepare_item_for_database:234@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function prepare_item_for_response($item, $request)
    {
        ...
        error_log('Removed function called prepare_item_for_response:252@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    public function get_item_schema()
    {
        ...
        error_log('Removed function called get_item_schema:303@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
    /**
    ...
    {
        return array('context' => $this->get_context_param(), 'page' => array('description' => __('Current page of the collection.'), 'type' => 'integer', 'default' => 1, 'sanitize_callback' => 'absint', 'validate_callback' => 'rest_validate_request_arg', 'minimum' => 1), 'per_page' => array('description' => __('Maximum number of items to be returned in result set.'), 'type' => 'integer', 'default' => 10, 'minimum' => 1, 'maximum' => 100, 'sanitize_callback' => 'absint', 'validate_callback' => 'rest_validate_request_arg'), 'search' => array('description' => __('Limit results to those matching a string.'), 'type' => 'string', 'sanitize_callback' => 'sanitize_text_field', 'validate_callback' => 'rest_validate_request_arg'));
    }
    /**
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("sanitize_slug") from ("/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php at line 570")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called sanitize_slug:570@/home/jovyan/work/WebApps/WP_spectral_Clusters/WP_spectral_2/wp-includes/rest-api/endpoints/class-wp-rest-controller.php');
        die();
    }
}