 ...
 * @package WordPress
 */
return array('title' => _x('Media and text with image on the right', 'Block pattern title'), 'categories' => array('header'), 'content' => '<!-- wp:media-text {"align":"full","mediaId":null,"mediaType":"image","verticalAlignment":"center"} -->
	...
	<!-- /wp:media-text -->', 'description' => _x('Media and text block with image to the left and text to the right', 'Block pattern description'));