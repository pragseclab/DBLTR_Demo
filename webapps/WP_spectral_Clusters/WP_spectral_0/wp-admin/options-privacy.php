...
if (!empty($privacy_policy_page_id)) {
    ...
    if (!$privacy_policy_page instanceof WP_Post) {
        ...
        if ('trash' === $privacy_policy_page->post_status) {
            add_settings_error('page_for_privacy_policy', 'page_for_privacy_policy', sprintf(
...
?>
	...
	<nav class="privacy-settings-tabs-wrapper hide-if-no-js" aria-label="<?php 
esc_attr_e('Secondary menu');
?>">
		<a href="<?php 
echo esc_url(admin_url('options-privacy.php'));
...
?>
		...
		<a href="<?php 
echo esc_url(admin_url('options-privacy.php?tab=policyguide'));
...
<div class="notice notice-error hide-if-js">
	<p><?php 
_e('The Privacy Settings require JavaScript.');
?></p>
</div>
