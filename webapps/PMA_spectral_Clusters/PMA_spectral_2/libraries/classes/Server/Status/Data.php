...
class Data
{
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("__set") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_2/libraries/classes/Server/Status/Data.php at line 64")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called __set:64@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_2/libraries/classes/Server/Status/Data.php');
        die();
    }
    /**
    ...
    private function getLinks()
    {
        ...
        $links['table'][__('Flush (close) all tables')] = ['url' => $this->selfUrl, 'params' => Url::getCommon(['flush' => 'TABLES'], '')];
        $links['table'][__('Show open tables')] = ['url' => Url::getFromRoute('/sql'), 'params' => Url::getCommon(['sql_query' => 'SHOW OPEN TABLES', 'goto' => $this->selfUrl], '')];
        if ($primaryInfo['status']) {
            $links['repl'][__('Show slave hosts')] = ['url' => Url::getFromRoute('/sql'), 'params' => Url::getCommon(['sql_query' => 'SHOW SLAVE HOSTS', 'goto' => $this->selfUrl], '')];
            $links['repl'][__('Show master status')] = ['url' => '#replication_master', 'params' => ''];
        }
        if ($replicaInfo['status']) {
            $links['repl'][__('Show slave status')] = ['url' => '#replication_slave', 'params' => ''];
        }
        $links['repl']['doc'] = 'replication';
        $links['qcache'][__('Flush query cache')] = ['url' => $this->selfUrl, 'params' => Url::getCommon(['flush' => 'QUERY CACHE'], '')];
        ...
        $links['innodb'][__('InnoDB Status')] = ['url' => Url::getFromRoute('/server/engines/InnoDB/Status'), 'params' => ''];
     ...
     */
    private function sortVariables(array $server_status, array $allocations, array $allocationMap, array $sectionUsed, array $used_queries)
    {
    ...
    public function __construct()
    {
        ...
        [$allocationMap, $sectionUsed, $used_queries] = $this->sortVariables($server_status, $allocations, $allocationMap, $sectionUsed, $used_queries);
    ...
    {
        $deprecated = ['Com_prepare_sql' => 'Com_stmt_prepare', 'Com_execute_sql' => 'Com_stmt_execute', 'Com_dealloc_sql' => 'Com_stmt_close'];
