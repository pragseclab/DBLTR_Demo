...
class Template
{
    ...
    public function __construct()
    {
        ...
        $twig = new Environment($loader, ['auto_reload' => true, 'cache' => $cache_dir]);
    ...
    private function load(string $templateName) : TemplateWrapper
    {
        try {
             ...
             * solve it.
             */
            trigger_error(sprintf(__('Error while working with template cache: %s'), $e->getMessage()), E_USER_WARNING);
        }
        return $template;
    }
    /**
