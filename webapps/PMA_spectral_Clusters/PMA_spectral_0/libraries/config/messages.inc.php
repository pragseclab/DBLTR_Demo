...
$strConfigArbitraryServerRegexp_desc = __('Restricts the MySQL servers the user can enter when a login to an arbitrary ' . 'MySQL server is enabled by matching the IP or hostname of the MySQL server ' . 'to the given regular expression.');
$strConfigArbitraryServerRegexp_name = __('Restrict login to MySQL server');
$strConfigAllowThirdPartyFraming_desc = __('Enabling this allows a page located on a different domain to call phpMyAdmin ' . 'inside a frame, and is a potential [strong]security hole[/strong] allowing ' . 'cross-frame scripting (XSS) attacks.');
...
$strConfigBZipDump_desc = __('Enable bzip2 compression for' . ' import operations.');
...
$strConfigCodemirrorEnable_desc = __('Use user-friendly editor for editing SQL queries ' . '(CodeMirror) with syntax highlighting and ' . 'line numbers.');
$strConfigCodemirrorEnable_name = __('Enable CodeMirror');
$strConfigLintEnable_desc = __('Find any errors in the query before executing it.' . ' Requires CodeMirror to be enabled.');
...
$strConfigShowColumnComments_desc = __('Whether column comments should be shown in table structure view');
...
$strConfigExport_lock_tables_name = sprintf(__('Use %s statement'), '<code>LOCK TABLES</code>');
...
$strConfigExport_sql_drop_table_name = sprintf(__('Add %s'), 'DROP TABLE / VIEW / PROCEDURE / FUNCTION / EVENT / TRIGGER');
...
$strConfigExport_sql_create_trigger_name = sprintf(__('Add %s'), 'CREATE TRIGGER');
$strConfigExport_sql_hex_for_binary_name = __('Use hexadecimal for BINARY & BLOB');
$strConfigExport_sql_if_not_exists_name = __('Add IF NOT EXISTS (less efficient as indexes will be generated during' . ' table creation)');
...
$strConfigDefaultForeignKeyChecks_desc = __('Default value for foreign key checks checkbox for some queries.');
...
$strConfigForm_Page_titles_desc = __('Specify browser\'s title bar text. Refer to ' . '[doc@faq6-27]documentation[/doc] for magic strings that can be used ' . 'to get special values.');
...
$strConfigGZipDump_desc = __('Enable gzip compression for import ' . 'and export operations.');
...
$strConfigLoginCookieRecall_desc = __('Define whether the previous login should be recalled or not in ' . '[kbd]cookie[/kbd] authentication mode.');
...
$strConfigFirstLevelNavigationItems_desc = __('The number of items that can be displayed on each page on the first level' . ' of the navigation tree.');
...
$strConfigMemoryLimit_desc = __('The number of bytes a script is allowed to allocate, eg. [kbd]32M[/kbd] ' . '([kbd]-1[/kbd] for no limit and [kbd]0[/kbd] for no change).');
...
$strConfigNavigationTreeDefaultTabTable2_name = __('Target for second quick access icon');
...
$strConfigNavigationTreeEnableGrouping_desc = __('Group items in the navigation tree (determined by the separator defined in ' . 'the Databases and Tables tabs above).');
...
$strConfigNavigationTreeEnableExpansion_desc = __('Whether to offer the possibility of tree expansion in the navigation panel.');
$strConfigNavigationTreeEnableExpansion_name = __('Enable navigation tree expansion');
$strConfigNavigationTreeShowTables_name = __('Show tables in tree');
$strConfigNavigationTreeShowTables_desc = __('Whether to show tables under database in the navigation tree');
$strConfigNavigationTreeShowViews_name = __('Show views in tree');
$strConfigNavigationTreeShowViews_desc = __('Whether to show views under database in the navigation tree');
$strConfigNavigationTreeShowFunctions_name = __('Show functions in tree');
$strConfigNavigationTreeShowFunctions_desc = __('Whether to show functions under database in the navigation tree');
$strConfigNavigationTreeShowProcedures_name = __('Show procedures in tree');
$strConfigNavigationTreeShowProcedures_desc = __('Whether to show procedures under database in the navigation tree');
$strConfigNavigationTreeShowEvents_name = __('Show events in tree');
$strConfigNavigationTreeShowEvents_desc = __('Whether to show events under database in the navigation tree');
$strConfigNumRecentTables_desc = __('Maximum number of recently used tables; set 0 to disable.');
$strConfigNumFavoriteTables_desc = __('Maximum number of favorite tables; set 0 to disable.');
...
$strConfigServers_bookmarktable_desc = __('Leave blank for no [doc@bookmarks@]bookmark[/doc] ' . 'support, suggested: [kbd]pma__bookmark[/kbd]');
...
$strConfigServers_controluser_desc = __('A special MySQL user configured with limited permissions, more information ' . 'available on [doc@linked-tables]documentation[/doc].');
...
$strConfigServers_DisableIS_desc = __('More information on [a@https://sourceforge.net/p/phpmyadmin/bugs/2606/]PMA ' . 'bug tracker[/a] and [a@https://bugs.mysql.com/19588]MySQL Bugs[/a]');
...
$strConfigServers_savedsearches_desc = __('Leave blank for no QBE saved searches support, suggested: ' . '[kbd]pma__savedsearches[/kbd].');
$strConfigServers_export_templates_name = __('Export templates table');
$strConfigServers_export_templates_desc = __('Leave blank for no export template support, suggested: ' . '[kbd]pma__export_templates[/kbd].');
$strConfigServers_central_columns_name = __('Central columns table');
$strConfigServers_central_columns_desc = __('Leave blank for no central columns support, suggested: ' . '[kbd]pma__central_columns[/kbd].');
...
$strConfigServers_pmadb_desc = __('Database used for relations, bookmarks, and PDF features. See ' . '[doc@linked-tables]pmadb[/doc] for complete information. ' . 'Leave blank for no support. Suggested: [kbd]phpmyadmin[/kbd].');
...
$strConfigServers_favorite_desc = __('Leave blank for no "persistent" favorite tables across sessions, ' . 'suggested: [kbd]pma__favorite[/kbd].');
$strConfigServers_favorite_name = __('Favorites table');
$strConfigServers_relation_desc = __('Leave blank for no ' . '[doc@relations@]relation-links[/doc] support, ' . 'suggested: [kbd]pma__relation[/kbd].');
$strConfigServers_relation_name = __('Relation table');
$strConfigServers_SignonSession_desc = __('See [doc@authentication-modes]authentication ' . 'types[/doc] for an example.');
...
$strConfigShowDbStructureCharset_desc = __('Show or hide a column displaying the charset for all tables.');
...
$strConfigShowPhpInfo_desc = __('Shows link to [a@https://php.net/manual/function.phpinfo.php]phpinfo()[/a] ' . 'output.');
...
$strConfigZipDump_desc = __('Enable ZIP ' . 'compression for import and export operations.');
...
$strConfigZeroConf_desc = __('Enable Zero Configuration mode which lets you setup phpMyAdmin ' . 'configuration storage tables automatically.');
