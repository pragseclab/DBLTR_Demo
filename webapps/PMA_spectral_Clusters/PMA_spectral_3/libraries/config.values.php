 ...
 */
return [
    'Servers' => [1 => ['port' => 'integer', 'auth_type' => ['config', 'http', 'signon', 'cookie'], 'AllowDeny' => ['order' => ['', 'deny,allow', 'allow,deny', 'explicit']], 'only_db' => 'array']],
    ...
    'RowActionLinks' => ['none' => __('Nowhere'), 'left' => __('Left'), 'right' => __('Right'), 'both' => __('Both')],
    ...
    'PDFDefaultPageSize' => ['A3' => 'A3', 'A4' => 'A4', 'A5' => 'A5', 'letter' => 'letter', 'legal' => 'legal'],
    'ActionLinksMode' => ['icons' => __('Icons'), 'text' => __('Text'), 'both' => __('Both')],
    'GridEditing' => ['click' => __('Click'), 'double-click' => __('Double click'), 'disabled' => __('Disabled')],
    ...
    'FirstDayOfCalendar' => ['1' => __('Monday'), '2' => __('Tuesday'), '3' => __('Wednesday'), '4' => __('Thursday'), '5' => __('Friday'), '6' => __('Saturday'), '7' => __('Sunday')],
    'SendErrorReports' => ['ask' => __('Ask before sending error reports'), 'always' => __('Always send error reports'), 'never' => __('Never send error reports')],
    'DefaultForeignKeyChecks' => ['default' => __('Server default'), 'enable' => __('Enable'), 'disable' => __('Disable')],
    'Import' => ['format' => [
        // CSV
        'csv',
        // DocSQL
        ...
        // SQL
        'sql',
    ], 'charset' => array_merge([''], $GLOBALS['cfg']['AvailableCharsets']), 'sql_compatibility' => [
        'NONE',
        'ANSI',
        'DB2',
        'MAXDB',
