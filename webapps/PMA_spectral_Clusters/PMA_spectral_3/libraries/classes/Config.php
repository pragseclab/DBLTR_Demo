...
class Config
{
    ...
    public function checkWebServer() : void
    {
        ...
        if (Core::getenv('SERVER_SOFTWARE') && stripos(Core::getenv('SERVER_SOFTWARE'), 'Microsoft') !== false && stripos(Core::getenv('SERVER_SOFTWARE'), 'IIS') !== false) {
    ...
    public function load(?string $source = null) : bool
    {
         ...
         */
        $matched_keys = array_filter(array_keys($cfg), static function ($key) {
    ...
    public function loadUserPreferences() : void
    {
        ...
        $server = $GLOBALS['server'] ?? (!empty($GLOBALS['cfg']['ServerDefault']) ? $GLOBALS['cfg']['ServerDefault'] : 0);
        ...
        if ($tmanager->getThemeCookie() || isset($_REQUEST['set_theme'])) {
            ...
            if ($tmanager->theme !== null && $this->settings['ThemeDefault'] != $tmanager->theme->getId() && $tmanager->checkTheme($this->settings['ThemeDefault'])) {
     ...
     * @return true|Message
     */
    public function setUserValue(?string $cookie_name, string $cfg_path, $new_cfg_value, $default_value = null)
    {
        $userPreferences = new UserPreferences();
        $result = true;
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("getUserValue") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_3/libraries/classes/Config.php at line 522")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called getUserValue:522@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_3/libraries/classes/Config.php');
        die();
    }
    /**
     * set source
    ...
    public function checkConfigSource() : bool
    {
        ...
        if (!@is_readable($this->getSource())) {
            ...
            if ($contents === false) {
                $this->sourceMtime = 0;
                Core::fatalError(sprintf(function_exists('__') ? __('Existing configuration file (%s) is not readable.') : 'Existing configuration file (%s) is not readable.', $this->getSource()));
                return false;
            }
        }
        return true;
    ...
    public function checkPermissions() : void
    {
        ...
        $this->sourceMtime = 0;
        Core::fatalError(__('Wrong permissions on configuration file, ' . 'should not be world writable!'));
    }
    /**
     * Checks for errors
     * (must be called after config.inc.php has been merged)
    ...
    public function checkErrors() : void
    {
        if ($this->errorConfigDefaultFile) {
            Core::fatalError(sprintf(__('Could not load default configuration from: %1$s'), $this->defaultSource));
        }
    ...
    {
        global $PMA_Theme;
        return (int) ($this->sourceMtime + $this->defaultSourceMtime + $this->get('user_preferences_mtime') + ($PMA_Theme->mtimeInfo ?? 0) + ($PMA_Theme->filesizeInfo ?? 0));
    }
    /**
    ...
    public function getRootPath() : string
    {
        ...
        $parts = explode('/', rtrim(str_replace('\\', '/', $parsedUrlPath), '/'));
        /* Remove filename */
    ...
    public function enableBc() : void
    {
        ...
        $defines = ['PMA_VERSION', 'PMA_MAJOR_VERSION', 'PMA_THEME_VERSION', 'PMA_THEME_GENERATION', 'PMA_IS_WINDOWS', 'PMA_IS_GD2', 'PMA_USR_OS', 'PMA_USR_BROWSER_VER', 'PMA_USR_BROWSER_AGENT'];
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("removeCookie") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_3/libraries/classes/Config.php at line 798")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called removeCookie:798@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_3/libraries/classes/Config.php');
        die();
    }
    /**
     ...
     * @return bool result of setcookie()
     */
    public function setCookie(string $cookie, string $value, ?string $default = null, ?int $validity = null, bool $httponly = true) : bool
    {
        global $cfg;
        ...
        if (!$this->issetCookie($cookie) || $this->getCookie($cookie) !== $value) {
            ...
            if (PHP_VERSION_ID < 70300) {
                return setcookie($httpCookieName, $value, $validity, $this->getRootPath() . '; samesite=' . $cfg['CookieSameSite'], '', $this->isHttps(), $httponly);
            }
            $optionalParams = ['expires' => $validity, 'path' => $this->getRootPath(), 'domain' => '', 'secure' => $this->isHttps(), 'httponly' => $httponly, 'samesite' => $cfg['CookieSameSite']];
    ...
    public static function fatalErrorHandler() : void
    {
        ...
        Core::fatalError(sprintf('Failed to load phpMyAdmin configuration (%s:%s): %s', Error::relPath($error['file']), $error['line'], $error['message']));
    }
    /**
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("getUploadTempDir") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_3/libraries/classes/Config.php at line 975")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called getUploadTempDir:975@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_3/libraries/classes/Config.php');
        die();
    }
    /**
    ...
    public function selectServer() : int
    {
        ...
        if (!is_numeric($request)) {
            foreach ($this->settings['Servers'] as $i => $server) {
                ...
                if ($server['host'] == $request || $server['verbose'] == $request || $verboseToLower == $serverToLower || md5($verboseToLower) === $serverToLower) {
                    $request = $i;
                    break;
                }
            }
    ...
    public static function getConnectionParams(int $mode, ?array $server = null) : array
    {
        ...
        if ($mode == DatabaseInterface::CONNECT_USER) {
            ...
            if ($server['host'] == $cfg['Server']['host']) {
                $shared = ['port', 'socket', 'compress', 'ssl', 'ssl_key', 'ssl_cert', 'ssl_ca', 'ssl_ca_path', 'ssl_ciphers', 'ssl_verify'];
