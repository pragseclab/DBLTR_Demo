...
class Utilities
{
    ...
    public static function debugLogQueryIntoSession(string $query, ?string $errorMessage, $result, $time) : void
    {
        ...
        error_log('Removed function called debugLogQueryIntoSession:140@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_3/libraries/classes/Query/Utilities.php');
        die();
    }
}