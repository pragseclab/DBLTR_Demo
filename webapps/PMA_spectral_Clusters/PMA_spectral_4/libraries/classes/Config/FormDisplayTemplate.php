...
class FormDisplayTemplate
{
    ...
    public function displayErrors($name, array $errorList) : string
    {
        ...
        error_log('Removed function called displayErrors:367@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_4/libraries/classes/Config/FormDisplayTemplate.php');
        die();
    }
}