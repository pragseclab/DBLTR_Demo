...
class Url
{
     ...
     * @access public
     */
    public static function getHiddenInputs($db = '', $table = '', $indent = 0, $skip = array())
    {
        global $PMA_Config;
        if (is_array($db)) {
            $params =& $db;
    ...
    {
        return htmlspecialchars(self::getCommonRaw($params, $divider));
    }
    /**
     * Generates text with URL parameters.
     *
     ...
     */
    public static function getFromRoute(string $route, array $additionalParameters = array()) : string
    {
