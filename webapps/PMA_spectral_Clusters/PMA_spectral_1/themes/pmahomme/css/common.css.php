...
html {
    font-size: <?php 
echo $_SESSION['PMA_Theme']->getFontSize();
?>
}
...
#initials_table a {
    ...
    border-radius: 5px;
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('ffffff', 'e0e0e0');
?>
}
...
#initials_table a.active {
    ...
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('bbbbbb', 'ffffff');
?>
}
...
?>;
    background: #f3f3f3;
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('ffffff', 'cccccc');
?>
}
...
input.button {
    ...
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('f8f8f8', 'd8d8d8');
?>
}
...
input.button:hover {
    position: relative;
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('fff', 'ddd');
?>
    cursor: pointer;
}
...
input.button:active {
    position: relative;
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('eee', 'ddd');
?>
...
select[multiple] {
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('ffffff', 'f2f2f2');
?>
}
...
table tr.marked:not(.nomarker) {
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('ced6df', 'b6c6d7');
?>
    color: <?php 
...
.menucontainer {
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('ffffff', 'dcdcdc');
?>
...
a.button:hover {
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('ffffff', 'dddddd');
?>
}
...
echo $_SESSION['PMA_Theme']->getImgPath('logo_right.png');
?>); */
...
?>: auto;
    ...
    right: 0;
    background-image: url(<?php 
echo $_SESSION['PMA_Theme']->getImgPath('ajax_clock_small.gif');
?>);
    background-repeat: no-repeat;
...
?>;
    margin-<?php 
echo $right;
?>: 0.3em; /* same as padding of "table td" */
}
...
.cPointer {
    background: url(<?php 
echo $_SESSION['PMA_Theme']->getImgPath('col_pointer.png');
?>);
    height: 20px;
    margin-<?php 
echo $left;
?>: -5px;  /* must be minus half of its width */
    margin-top: -10px;
    position: absolute;
    width: 10px;
}
...
.coldrop {
    background: url(<?php 
echo $_SESSION['PMA_Theme']->getImgPath('col_drop.png');
?>);
    cursor: pointer;
    height: 16px;
    margin-<?php 
...
.navigation {
    ...
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('eeeeee', 'cccccc');
?>
}
...
.navigation input.edit_mode_active {
    ...
    <?php 
echo $_SESSION['PMA_Theme']->getCssGradient('333333', '555555');
?>
}
...
.ui-timepicker-div dl { text-align: <?php 
echo $left;
?>; }
...
span.drag_icon {
    display: inline-block;
    background-image: url('<?php 
echo $_SESSION['PMA_Theme']->getImgPath('s_sortable.png');
?>');
...
th.headerSortUp .sorticon, th.headerSortDown:hover .sorticon {
    background-image: url(<?php 
echo $_SESSION['PMA_Theme']->getImgPath('s_desc.png');
?>);
}

th.headerSortDown .sorticon, th.headerSortUp:hover .sorticon {
    background-image: url(<?php 
echo $_SESSION['PMA_Theme']->getImgPath('s_asc.png');
?>);
}
