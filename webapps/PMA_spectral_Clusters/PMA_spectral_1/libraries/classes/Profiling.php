...
final class Profiling
{
    ...
    public static function check(DatabaseInterface $dbi, Response $response) : void
    {
        ...
        $scripts->addFiles(['chart.js', 'vendor/jqplot/jquery.jqplot.js', 'vendor/jqplot/plugins/jqplot.pieRenderer.js', 'vendor/jqplot/plugins/jqplot.highlighter.js', 'vendor/jquery/jquery.tablesorter.js']);
    }
}