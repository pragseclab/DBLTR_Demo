...
class Scripts
{
     ...
     * @return void
     */
    public function addFile($filename, array $params = array())
    {
        $hash = md5($filename);
        ...
        $this->files[$hash] = ['has_onload' => $has_onload, 'filename' => $filename, 'params' => $params];
    }
    /**
    ...
    public function getDisplay()
    {
        ...
        return $this->template->render('scripts', ['base_dir' => $baseDir, 'files' => $this->files, 'version' => PMA_VERSION, 'code' => $this->code]);
    }
}