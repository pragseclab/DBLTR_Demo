...
class AddFieldController extends AbstractController
{
    ...
    public function index() : void
    {
         ...
         */
        $err_url = Url::getFromRoute('/table/sql', ['db' => $db, 'table' => $table]);
        ...
        if (isset($_POST['submit_num_fields'])) {
            ...
            $num_fields = min(intval($_POST['orig_num_fields']) + intval($_POST['added_fields']), 4096);
            $regenerate = true;
        ...
        if (isset($_POST['do_save_data'])) {
            ...
            if ($result !== true) {
                $error_message_html = Generator::mysqlDie('', '', false, $err_url, false);
        ...
        $templateData = ColumnsDefinition::displayForm($this->transformations, $this->relation, $this->dbi, $action, $num_fields, $regenerate);
