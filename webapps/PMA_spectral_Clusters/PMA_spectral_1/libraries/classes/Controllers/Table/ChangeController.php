...
class ChangeController extends AbstractController
{
     ...
     */
    public function __construct($response, Template $template, $db, $table, InsertEdit $insertEdit, Relation $relation)
    {
    ...
    public function index() : void
    {
         ...
         */
        [$insert_mode, $where_clause, $where_clause_array, $where_clauses, $result, $rows, $found_unique_key, $after_insert] = $this->insertEdit->determineInsertOrEdit($where_clause ?? null, $db, $table);
        ...
        $err_url = $GLOBALS['goto'] . Url::getCommon($_url_params, mb_strpos($GLOBALS['goto'], '?') === false ? '?' : '&');
        unset($_url_params);
        $comments_map = $this->insertEdit->getCommentsMap($db, $table);
        /**
         * START REGULAR OUTPUT
         */
        $this->addScriptFiles(['makegrid.js', 'vendor/stickyfill.min.js', 'sql.js', 'table/change.js', 'vendor/jquery/additional-methods.js', 'gis_data_editor.js']);
        /**
        ...
        $_form_params = $this->insertEdit->getFormParametersForInsertForm($db, $table, $where_clauses, $where_clause_array, $err_url);
        /**
         * Displays the form
         */
        ...
        $url_params = $this->insertEdit->urlParamsInEditMode($url_params, $where_clause_array);
        ...
        foreach ($rows as $row_id => $current_row) {
            ...
            $html_output .= $this->insertEdit->getHtmlForInsertEditRow($url_params, $table_columns, $comments_map, $timestamp_seen, $current_result, $chg_evt_handler, $jsvkey, $vkey, $insert_mode, $current_row, $o_rows, $tabindex, $columns_cnt, $is_upload, $tabindex_for_function, $foreigners, $tabindex_for_null, $tabindex_for_value, $table, $db, $row_id, $biggest_max_file_size, $text_dir, $repopulate, $where_clause_array);
        }
        ...
        //action panel
        $html_output .= $this->insertEdit->getActionsPanel($where_clause, $after_insert, $tabindex, $tabindex_for_value, $found_unique_key);
        ...
        if ($insert_mode) {
            ...
            $html_output .= $this->insertEdit->getContinueInsertionForm($table, $db, $where_clause_array, $err_url);
        }
        $this->response->addHTML($html_output);
    }
    public function rows() : void
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("rows") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Controllers/Table/ChangeController.php at line 175")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called rows:175@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Controllers/Table/ChangeController.php');
        die();
    }
}