...
final class SqlController extends AbstractController
{
    ...
    public function index() : void
    {
        ...
        $this->addScriptFiles(['makegrid.js', 'vendor/jquery/jquery.uitablefilter.js', 'vendor/stickyfill.min.js', 'sql.js']);
        ...
        $this->response->addHTML($this->sqlQueryForm->getHtml($_GET['sql_query'] ?? true, false, isset($_POST['delimiter']) ? htmlspecialchars($_POST['delimiter']) : ';'));
    }
}