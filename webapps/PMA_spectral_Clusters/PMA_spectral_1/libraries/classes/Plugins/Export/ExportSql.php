...
class ExportSql extends ExportPlugin
{
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("exportRoutineSQL") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 276")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called exportRoutineSQL:276@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
    ...
    public function exportRoutines($db, array $aliases = [])
    {
        ...
        if ($procedure_names || $function_names) {
            ...
            if ($procedure_names) {
                $text .= $this->exportRoutineSQL($db, $aliases, 'PROCEDURE', __('Procedures'), $procedure_names, $delimiter);
            }
            if ($function_names) {
                $text .= $this->exportRoutineSQL($db, $aliases, 'FUNCTION', __('Functions'), $function_names, $delimiter);
            }
            $text .= 'DELIMITER ;' . $crlf;
        }
        if (!empty($text)) {
    ...
    public function exportHeader()
    {
        ...
        $head = $this->exportComment('phpMyAdmin SQL Dump') . $this->exportComment('version ' . PMA_VERSION) . $this->exportComment('https://www.phpmyadmin.net/') . $this->exportComment();
        $host_string = __('Host:') . ' ' . $cfg['Server']['host'];
        if (!empty($cfg['Server']['port'])) {
            $host_string .= ':' . $cfg['Server']['port'];
        }
        $head .= $this->exportComment($host_string);
        $head .= $this->exportComment(__('Generation Time:') . ' ' . Util::localisedDate()) . $this->exportComment(__('Server version:') . ' ' . $dbi->getVersionString()) . $this->exportComment(__('PHP Version:') . ' ' . PHP_VERSION) . $this->possibleCRLF();
    ...
    public function exportDBCreate($db, $export_type, $db_alias = '')
    {
        ...
        if (isset($GLOBALS['sql_drop_database'])) {
            if (!$this->export->outputHandler('DROP DATABASE IF EXISTS ' . Util::backquoteCompat($db_alias, $compat, isset($GLOBALS['sql_backquotes'])) . ';' . $crlf)) {
                return false;
            }
        }
        ...
        if (mb_strpos($collation, '_')) {
            $create_query .= ' DEFAULT CHARACTER SET ' . mb_substr($collation, 0, (int) mb_strpos($collation, '_')) . ' COLLATE ' . $collation;
        } else {
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("exportUseStatement") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 512")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called exportUseStatement:512@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
    ...
    public function exportDBHeader($db, $db_alias = '')
    {
        ...
        $head = $this->exportComment() . $this->exportComment(__('Database:') . ' ' . Util::backquoteCompat($db_alias, $compat, isset($GLOBALS['sql_backquotes']))) . $this->exportComment();
        return $this->export->outputHandler($head);
    }
    /**
    ...
    public function exportEvents($db)
    {
        ...
        $text = '';
        $delimiter = '$$';
        $event_names = $dbi->fetchResult('SELECT EVENT_NAME FROM information_schema.EVENTS WHERE' . " EVENT_SCHEMA= '" . $dbi->escapeString($db) . "';");
        if ($event_names) {
            $text .= $crlf . 'DELIMITER ' . $delimiter . $crlf;
            $text .= $this->exportComment() . $this->exportComment(__('Events')) . $this->exportComment();
            foreach ($event_names as $event_name) {
                if (!empty($GLOBALS['sql_drop_table'])) {
                    $text .= 'DROP EVENT IF EXISTS ' . Util::backquote($event_name) . $delimiter . $crlf;
                }
                $text .= $dbi->getDefinition($db, 'EVENT', $event_name) . $delimiter . $crlf . $crlf;
            }
            $text .= 'DELIMITER ;' . $crlf;
        }
        if (!empty($text)) {
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("exportMetadata") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 609")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called exportMetadata:609@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
     * Exports metadata from Configuration Storage
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("exportConfigurationMetadata") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 645")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called exportConfigurationMetadata:645@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("getTableDefStandIn") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 723")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called getTableDefStandIn:723@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("getTableDefForView") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 761")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called getTableDefForView:761@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
    ...
    {
        global $sql_drop_table, $sql_backquotes, $sql_constraints, $sql_constraints_query, $sql_indexes, $sql_indexes_query, $sql_auto_increments, $sql_drop_foreign_keys, $dbi;
        $db_alias = $db;
        $table_alias = $table;
        ...
        $result = $dbi->tryQuery('SHOW TABLE STATUS FROM ' . Util::backquote($db) . ' WHERE Name = \'' . $dbi->escapeString((string) $table) . '\'', DatabaseInterface::CONNECT_USER, DatabaseInterface::QUERY_STORE);
        if ($result != false) {
            if ($dbi->numRows($result) > 0) {
                ...
                if ($show_dates && isset($tmpres['Create_time']) && !empty($tmpres['Create_time'])) {
                    $schema_create .= $this->exportComment(__('Creation:') . ' ' . Util::localisedDate(strtotime($tmpres['Create_time'])));
                    $new_crlf = $this->exportComment() . $crlf;
                }
                if ($show_dates && isset($tmpres['Update_time']) && !empty($tmpres['Update_time'])) {
                    $schema_create .= $this->exportComment(__('Last update:') . ' ' . Util::localisedDate(strtotime($tmpres['Update_time'])));
                    $new_crlf = $this->exportComment() . $crlf;
                }
                if ($show_dates && isset($tmpres['Check_time']) && !empty($tmpres['Check_time'])) {
                    $schema_create .= $this->exportComment(__('Last check:') . ' ' . Util::localisedDate(strtotime($tmpres['Check_time'])));
                    $new_crlf = $this->exportComment() . $crlf;
                }
            }
        ...
        if (!empty($sql_drop_table) && $dbi->getTable($db, $table)->isView()) {
            $schema_create .= 'DROP VIEW IF EXISTS ' . Util::backquote($table_alias, $sql_backquotes) . ';' . $crlf;
        }
        ...
        $result = $dbi->tryQuery('SHOW CREATE TABLE ' . Util::backquote($db) . '.' . Util::backquote($table));
        ...
        if ($row) {
            ...
            if ($view) {
                ...
                if (isset($GLOBALS['sql_or_replace_view'])) {
                    $create_query = preg_replace('/^CREATE/', 'CREATE OR REPLACE', $create_query);
                }
            }
            ...
            if ($flag && $view) {
                $warning = $this->exportComment() . $this->exportComment(__('It appears your database uses views;')) . $this->exportComment(__('alias export may not work reliably in all cases.')) . $this->exportComment();
            }
            ...
            if ($compat === 'MSSQL') {
                $create_query = $this->makeCreateTableMSSQLCompatible($create_query);
            }
            ...
            if (!empty($statement->fields) && (empty($engine) || strtoupper($engine) !== 'ARCHIVE')) {
                    ...
                    if ($field->isConstraint) {
                        ...
                        if ($field->key->type === 'FULLTEXT KEY') {
                            ...
                            if (empty($GLOBALS['sql_if_not_exists'])) {
                                $indexes[] = str_replace('COMMENT=\'', 'COMMENT \'', $field::build($field));
                                unset($statement->fields[$key]);
                            }
                        }
                    }
                ...
                if (!empty($auto_increment) && $update_indexes_increments) {
                    ...
                    if (isset($GLOBALS['sql_auto_increment']) && $statement->entityOptions->has('AUTO_INCREMENT') !== false) {
                        if (!isset($GLOBALS['table_data']) || isset($GLOBALS['table_data']) && in_array($table, $GLOBALS['table_data'])) {
    ...
    private function getTableComments($db, $table, $crlf, $do_relation = false, $do_mime = false, array $aliases = [])
    {
        ...
        [$res_rel, $have_rel] = $this->relation->getRelationsAndStatus($do_relation && !empty($cfgRelation['relation']), $db, $table);
        ...
        if (isset($mime_map) && count($mime_map) > 0) {
            $schema_create .= $this->possibleCRLF() . $this->exportComment() . $this->exportComment(__('MEDIA TYPES FOR TABLE') . ' ' . Util::backquote($table, $sql_backquotes) . ':');
            foreach ($mime_map as $mime_field => $mime) {
                $schema_create .= $this->exportComment('  ' . Util::backquote($mime_field, $sql_backquotes)) . $this->exportComment('      ' . Util::backquote($mime['mimetype'], $sql_backquotes));
            }
            $schema_create .= $this->exportComment();
        }
        if ($have_rel) {
            $schema_create .= $this->possibleCRLF() . $this->exportComment() . $this->exportComment(__('RELATIONSHIPS FOR TABLE') . ' ' . Util::backquote($table_alias, $sql_backquotes) . ':');
            foreach ($res_rel as $rel_field => $rel) {
                if ($rel_field !== 'foreign_keys_data') {
                    ...
                    $schema_create .= $this->exportComment('  ' . Util::backquote($rel_field_alias, $sql_backquotes)) . $this->exportComment('      ' . Util::backquote($rel['foreign_table'], $sql_backquotes) . ' -> ' . Util::backquote($rel['foreign_field'], $sql_backquotes));
                } else {
                    foreach ($rel as $one_key) {
                        foreach ($one_key['index_list'] as $index => $field) {
                            ...
                            $schema_create .= $this->exportComment('  ' . Util::backquote($rel_field_alias, $sql_backquotes)) . $this->exportComment('      ' . Util::backquote($one_key['ref_table_name'], $sql_backquotes) . ' -> ' . Util::backquote($one_key['ref_index_list'][$index], $sql_backquotes));
                        }
                    }
                }
            }
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("exportRawQuery") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 1204")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called exportRawQuery:1204@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
    ...
    public function exportStructure($db, $table, $crlf, $error_url, $export_mode, $export_type, $relation = false, $comments = false, $mime = false, $dates = false, array $aliases = [])
    {
        ...
        $dump = $this->possibleCRLF() . $this->exportComment(str_repeat('-', 56)) . $this->possibleCRLF() . $this->exportComment();
        switch ($export_mode) {
            case 'create_table':
                $dump .= $this->exportComment(__('Table structure for table') . ' ' . $formatted_table_name);
            ...
            case 'triggers':
                ...
                if ($triggers) {
                    $dump .= $this->possibleCRLF() . $this->exportComment() . $this->exportComment(__('Triggers') . ' ' . $formatted_table_name) . $this->exportComment();
                    $used_alias = false;
                    $trigger_query = '';
                    ...
                    if ($used_alias) {
                        $dump .= $this->exportComment(__('It appears your table uses triggers;')) . $this->exportComment(__('alias export may not work reliably in all cases.')) . $this->exportComment();
                    }
                    $dump .= $trigger_query;
                }
                break;
            case 'create_view':
                if (empty($GLOBALS['sql_views_as_tables'])) {
                    $dump .= $this->exportComment(__('Structure for view') . ' ' . $formatted_table_name) . $this->exportComment();
                    ...
                    $dump .= $this->exportComment(sprintf(__('Structure for view %s exported as a table'), $formatted_table_name)) . $this->exportComment();
                    // delete the stand-in table previously created (if any)
                    if ($export_type !== 'table') {
                        $dump .= 'DROP TABLE IF EXISTS ' . Util::backquote($table_alias) . ';' . $crlf;
                    }
                ...
                break;
            case 'stand_in':
                $dump .= $this->exportComment(__('Stand-in structure for view') . ' ' . $formatted_table_name) . $this->exportComment(__('(See below for the actual view)')) . $this->exportComment();
    ...
    public function exportData($db, $table, $crlf, $error_url, $sql_query, array $aliases = [])
    {
        ...
        if ($dbi->getTable($db, $table)->isView() && empty($GLOBALS['sql_views_as_tables'])) {
            $head = $this->possibleCRLF() . $this->exportComment() . $this->exportComment('VIEW ' . $formatted_table_name) . $this->exportComment(__('Data:') . ' ' . __('None')) . $this->exportComment() . $this->possibleCRLF();
            return $this->export->outputHandler($head);
        }
        $result = $dbi->tryQuery($sql_query, DatabaseInterface::CONNECT_USER, DatabaseInterface::QUERY_UNBUFFERED);
        ...
        if ($tmp_error) {
            ...
            return $this->export->outputHandler($this->exportComment($message));
        }
        if ($result == false) {
            $dbi->freeResult($result);
            return true;
        ...
        if (isset($GLOBALS['sql_type']) && $GLOBALS['sql_type'] === 'UPDATE') {
            ...
            if (isset($GLOBALS['sql_truncate']) && $GLOBALS['sql_truncate'] && $sql_command === 'INSERT') {
                ...
                $truncatehead = $this->possibleCRLF() . $this->exportComment() . $this->exportComment(__('Truncate table before insert') . ' ' . $formatted_table_name) . $this->exportComment() . $crlf;
        ...
        while ($row = $dbi->fetchRow($result)) {
            if ($current_row == 0) {
                $head = $this->possibleCRLF() . $this->exportComment() . $this->exportComment(__('Dumping data for table') . ' ' . $formatted_table_name) . $this->exportComment() . $crlf;
            ...
            if (isset($GLOBALS['sql_compatibility']) && $GLOBALS['sql_compatibility'] === 'MSSQL' && $current_row == 0) {
                if (!$this->export->outputHandler('SET IDENTITY_INSERT ' . Util::backquoteCompat($table_alias, $compat, $sql_backquotes) . ' ON ;' . $crlf)) {
                    return false;
                }
            }
            $current_row++;
            ...
            for ($j = 0; $j < $fields_cnt; $j++) {
                ...
                if (!isset($row[$j]) || $row[$j] === null) {
                    ...
                    // sometimes numeric
                    $values[] = $row[$j];
                } elseif (stripos($field_flags[$j], 'BINARY') !== false && isset($GLOBALS['sql_hex_for_binary'])) {
                    // a true BLOB
                    ...
                    $values[] = "b'" . $dbi->escapeString(Util::printableBitValue((int) $row[$j], (int) $fields_meta[$j]->length)) . "'";
            ...
            if (isset($GLOBALS['sql_type']) && $GLOBALS['sql_type'] === 'UPDATE') {
                ...
                [$tmp_unique_condition, $tmp_clause_is_unique] = Util::getUniqueCondition($result, $fields_cnt, $fields_meta, $row);
            ...
            unset($values);
            if (!$this->export->outputHandler(($current_row == 1 ? '' : $separator . $crlf) . $insert_line)) {
                return false;
            }
        }
        if ($current_row > 0) {
        ...
        if (isset($GLOBALS['sql_compatibility']) && $GLOBALS['sql_compatibility'] === 'MSSQL' && $current_row > 0) {
            $outputSucceeded = $this->export->outputHandler($crlf . 'SET IDENTITY_INSERT ' . Util::backquoteCompat($table_alias, $compat, $sql_backquotes) . ' OFF;' . $crlf);
            if (!$outputSucceeded) {
                return false;
            }
        }
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("makeCreateTableMSSQLCompatible") from ("/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php at line 1543")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called makeCreateTableMSSQLCompatible:1543@/home/jovyan/work/WebApps/PMA_spectral_Clusters/PMA_spectral_1/libraries/classes/Plugins/Export/ExportSql.php');
        die();
    }
    /**
    ...
    public function replaceWithAliases($sql_query, array $aliases, $db, $table = '', &$flag = null)
    {
        ...
        if ($statement->options->has('TRIGGER') || $statement->options->has('PROCEDURE') || $statement->options->has('FUNCTION') || $statement->options->has('VIEW')) {
            ...
            for ($i = 0, $count = count((array) $statement->body); $i < $count; ++$i) {
                ...
                $replaceToken = $isSymbol && !($token->flags & Token::FLAG_SYMBOL_VARIABLE) || ($isKeyword && !($token->flags & Token::FLAG_KEYWORD_RESERVED) || $isNone);
                if (!$replaceToken) {
                    continue;
                }
    ...
    protected function generateComment($crlf, ?string $sql_statement, $comment1, $comment2, $table_alias, $compat)
    {
        if (!isset($sql_statement)) {
            if (isset($GLOBALS['no_constraints_comments'])) {
                ...
                $sql_statement = $crlf . $this->exportComment() . $this->exportComment($comment1) . $this->exportComment();
            }
        }
        // comments for current table
        if (!isset($GLOBALS['no_constraints_comments'])) {
            $sql_statement .= $crlf . $this->exportComment() . $this->exportComment($comment2 . ' ' . Util::backquoteCompat($table_alias, $compat, isset($GLOBALS['sql_backquotes']))) . $this->exportComment();
        }
