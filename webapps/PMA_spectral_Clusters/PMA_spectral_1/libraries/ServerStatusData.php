...
class ServerStatusData
{
    ...
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("__set") from ("/home/jovyan/work/webapps/PMA_spectral_Clusters/PMA_spectral_1/libraries/ServerStatusData.php at line 48")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called __set:48@/home/jovyan/work/webapps/PMA_spectral_Clusters/PMA_spectral_1/libraries/ServerStatusData.php');
        die();
    }
    /**
    ...
    private function _getLinks()
    {
        ...
        $links['table'][__('Flush (close) all tables')] = $this->selfUrl . URL::getCommon(array('flush' => 'TABLES'));
        $links['table'][__('Show open tables')] = 'sql.php' . URL::getCommon(array('sql_query' => 'SHOW OPEN TABLES', 'goto' => $this->selfUrl));
        if ($GLOBALS['replication_info']['master']['status']) {
            $links['repl'][__('Show slave hosts')] = 'sql.php' . URL::getCommon(array('sql_query' => 'SHOW SLAVE HOSTS', 'goto' => $this->selfUrl));
        ...
        $links['qcache'][__('Flush query cache')] = $this->selfUrl . URL::getCommon(array('flush' => 'QUERY CACHE'));
        $links['qcache']['doc'] = 'query_cache';
        $links['threads']['doc'] = 'mysql_threads';
        $links['key']['doc'] = 'myisam_key_cache';
        $links['binlog_cache']['doc'] = 'binary_log';
        $links['Slow_queries']['doc'] = 'slow_query_log';
        $links['innodb'][__('Variables')] = 'server_engines.php?' . URL::getCommon(array('engine' => 'InnoDB'));
        $links['innodb'][__('InnoDB Status')] = 'server_engines.php' . URL::getCommon(array('engine' => 'InnoDB', 'page' => 'Status'));
    ...
    {
        // Key_buffer_fraction
        if (isset($server_status['Key_blocks_unused']) && isset($server_variables['key_cache_block_size']) && isset($server_variables['key_buffer_size']) && $server_variables['key_buffer_size'] != 0) {
        ...
        } elseif (isset($server_status['Key_blocks_used']) && isset($server_variables['key_buffer_size']) && $server_variables['key_buffer_size'] != 0) {
     ...
     */
    private function _sortVariables($server_status, $allocations, $allocationMap, $sectionUsed, $used_queries)
    {
    ...
    public function __construct()
    {
        ...
        // calculate some values
        $server_status = $this->_calculateValues($server_status, $server_variables);
        ...
        list($allocationMap, $sectionUsed, $used_queries) = $this->_sortVariables($server_status, $allocations, $allocationMap, $sectionUsed, $used_queries);
        ...
        $serverHostToLower = mb_strtolower($GLOBALS['cfg']['Server']['host']);
    ...
    {
        $deprecated = array('Com_prepare_sql' => 'Com_stmt_prepare', 'Com_execute_sql' => 'Com_stmt_execute', 'Com_dealloc_sql' => 'Com_stmt_close');
    ...
    public function getMenuHtml()
    {
        ...
        $items = array(array('name' => __('Server'), 'url' => 'server_status.php'), array('name' => __('Processes'), 'url' => 'server_status_processes.php'), array('name' => __('Query statistics'), 'url' => 'server_status_queries.php'), array('name' => __('All status variables'), 'url' => 'server_status_variables.php'), array('name' => __('Monitor'), 'url' => 'server_status_monitor.php'), array('name' => __('Advisor'), 'url' => 'server_status_advisor.php'));
     ...
     * @return string
     */
    public static function getHtmlForRefreshList($name, $defaultRate = 5, $refreshRates = array(1, 2, 5, 10, 20, 40, 60, 120, 300, 600))
    {
        echo('<html><head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">    <title>Error, Target Function Has Been Removed</title>    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">    <style>        * {            font-family: tahoma;        }        div.container .panel {            position: relative !important;        }        div.container {            width: 50% !important;            height: 50% !important;            overflow: auto !important;            margin: auto !important;            position: absolute !important;            top: 0 !important;            left: 0 !important;            bottom: 0 !important;            right: 0 !important;        }    </style></head><body>    <div class="container">        <div class="panel panel-danger center">            <div class="panel-heading" style="text-align: left;"> Error </div>            <div class="panel-body">                <p class="text-center">                  This function has been removed ("getHtmlForRefreshList") from ("/home/jovyan/work/webapps/PMA_spectral_Clusters/PMA_spectral_1/libraries/ServerStatusData.php at line 482")                </p>            </div>        </div>    </div></body></html>');
        error_log('Removed function called getHtmlForRefreshList:482@/home/jovyan/work/webapps/PMA_spectral_Clusters/PMA_spectral_1/libraries/ServerStatusData.php');
        die();
    }
}