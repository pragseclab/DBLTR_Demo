...
class Console
{
    ...
    public static function getBookmarkContent() : string
    {
        ...
        if ($cfgBookmark) {
            ...
            return $template->render('console/bookmark_content', ['welcome_message' => $welcomeMessage, 'bookmarks' => $bookmarks]);
        }
        return '';
    }
    /**
    ...
    public function getDisplay() : string
    {
        if (!$this->isAjax && $this->isEnabled) {
            ...
            return $this->template->render('console/display', ['cfg_bookmark' => $cfgBookmark, 'image' => $image, 'sql_history' => $_sql_history, 'bookmark_content' => $bookmarkContent]);
        }
        return '';
    }
}